...
---
# <a name="working-with-the-configuration-framework"></a><span data-ttu-id="2d2a5-102">處理組態架構</span><span class="sxs-lookup"><span data-stu-id="2d2a5-102">Working with the Configuration Framework</span></span>
<span data-ttu-id="2d2a5-103">「組態架構」可以讓您在安裝過程中快速輕鬆地變更 Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] 組態。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-103">The Configuration Framework enables you to quickly and easily change Microsoft [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] configuration at setup.</span></span> <span data-ttu-id="2d2a5-104">若搭配使用 Microsoft Windows Installer (MSI)，「組態架構」還可讀取及報告電腦的狀態以及需要採取行動的組態工作。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-104">In conjunction with the Microsoft Windows Installer (MSI), the Configuration Framework reads and reports the state of your computer and the configuration tasks requiring action.</span></span>  
  
 <span data-ttu-id="2d2a5-105">當您第一次使用「組態精靈」設定 BizTalk Server 時，「組態架構」會產生 XML 檔案 (組態快照集)，然後您可以修改 (也就是變更使用者名稱、密碼等等) 並匯出至其他電腦。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-105">When you configure BizTalk Server for the first time using the Configuration Wizard, the Configuration Framework generates an XML file (a configuration snapshot) that you can then modify (that is, change user names, passwords, and so on) and export to other computers.</span></span> <span data-ttu-id="2d2a5-106">您可以將組態快照集儲存在 [組態摘要] 頁面中，這是「組態精靈」的一部分。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-106">You save your configuration snapshot on the Configuration Summary page, part of the Configuration Wizard.</span></span> <span data-ttu-id="2d2a5-107">您可以使用此快照集來複寫組態做為指令碼安裝的一部分。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-107">You can use this snapshot to replicate your configuration as part of a scripted installation.</span></span> <span data-ttu-id="2d2a5-108">這個檔案位於\< *BizTalk 安裝路徑*> \ConfigMain.xml。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-108">This file is located at \<*BizTalk Installation Path*>\ConfigMain.xml.</span></span>  
  
> [!NOTE]
>  <span data-ttu-id="2d2a5-109">密碼不是儲存在 XML 檔案。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-109">Passwords are not stored in the XML file.</span></span> <span data-ttu-id="2d2a5-110">您必須先輸入密碼，才能使用此檔案。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-110">You must enter any passwords before you use this file.</span></span>  
  
## <a name="configuration-framework-command-line-parameters"></a><span data-ttu-id="2d2a5-111">組態架構命令列參數</span><span class="sxs-lookup"><span data-stu-id="2d2a5-111">Configuration Framework Command Line Parameters</span></span>  
 <span data-ttu-id="2d2a5-112">下表描述您可以在「組態架構」中的命令列執行的參數。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-112">The following table describes the parameters you can run on the command line within the Configuration Framework.</span></span>  
  
|<span data-ttu-id="2d2a5-113">命令列參數</span><span class="sxs-lookup"><span data-stu-id="2d2a5-113">Command Line Parameter</span></span>|<span data-ttu-id="2d2a5-114">描述</span><span class="sxs-lookup"><span data-stu-id="2d2a5-114">Description</span></span>|  
|----------------------------|-----------------|  
|<span data-ttu-id="2d2a5-115">**/U**</span><span class="sxs-lookup"><span data-stu-id="2d2a5-115">**/U**</span></span>|<span data-ttu-id="2d2a5-116">取消設定所有功能。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-116">Unconfigures all features.</span></span> <span data-ttu-id="2d2a5-117">**注意：**取消設定 BizTalk Server 功能之後，才能刪除 BizTalk Server 資料庫。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-117">**Note:**  You can delete BizTalk Server databases after you unconfigure BizTalk Server features.</span></span> <span data-ttu-id="2d2a5-118">執行此命令之前，請勿刪除 BizTalk Server 資料庫。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-118">Do not delete BizTalk Server databases before you run this command.</span></span> <span data-ttu-id="2d2a5-119">**注意：**如果您想要在取消設定 BizTalk Server 功能之後刪除 BizTalk Server 資料庫，建議您使用 **net stop winmgmt** 命令，停止可能仍在執行的 Windows Management Instrumentation (WMI) 服務。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-119">**Note:**  If you want to delete BizTalk Server databases after you unconfigure BizTalk Server features, we recommend that you use the **net stop winmgmt** command to stop the Windows Management Instrumentation (WMI) service, which may still be running.</span></span>|  
|<span data-ttu-id="2d2a5-120">**/S**</span><span class="sxs-lookup"><span data-stu-id="2d2a5-120">**/S**</span></span>|<span data-ttu-id="2d2a5-121">無訊息組態。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-121">Silent configuration.</span></span><br /><br /> <span data-ttu-id="2d2a5-122">您也必須將包含要安裝和設定之功能的完整路徑傳送至組態 XML。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-122">You must also pass the full path to the configuration XML that contains the features to install and configure.</span></span> <span data-ttu-id="2d2a5-123">若未傳遞 **/s**，則會在「使用者介面」(UI) 模式下執行工具。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-123">If **/s** is not passed, the tool runs in User Interface (UI) mode.</span></span>|  
|<span data-ttu-id="2d2a5-124">**/L**</span><span class="sxs-lookup"><span data-stu-id="2d2a5-124">**/L**</span></span>|<span data-ttu-id="2d2a5-125">-   設定記錄檔的完整路徑 (選擇性)。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-125">-   Sets the full path to the log file (optional).</span></span>|  
|<span data-ttu-id="2d2a5-126">**/H**</span><span class="sxs-lookup"><span data-stu-id="2d2a5-126">**/H**</span></span>|<span data-ttu-id="2d2a5-127">-   顯示有效的命令列參數。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-127">-   Shows the valid command line parameters.</span></span>|  
  
## <a name="sample-configuration-xml-file"></a><span data-ttu-id="2d2a5-128">範例組態 XML 檔案</span><span class="sxs-lookup"><span data-stu-id="2d2a5-128">Sample Configuration XML File</span></span>  
 <span data-ttu-id="2d2a5-129">以下是安裝所有功能的範例組態 XML 檔案。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-129">The following is a sample configuration XML file with all features installed.</span></span> <span data-ttu-id="2d2a5-130">若要建立您自己的組態檔，請使用 [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] 上的 [自訂組態] 選項 ，確認所有元件順利完成，然後選擇 [組態] 視窗中的 [匯出組態]。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-130">To create your own configuration file, use the Custom configuration option on a [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)], confirm all the components complete successfully, and then choose **Export Configuration** in the Configuration window.</span></span> <span data-ttu-id="2d2a5-131">您即可使用匯出的組態檔來設定其他 [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]。</span><span class="sxs-lookup"><span data-stu-id="2d2a5-131">You can then use the exported configuration file to configure other [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]s.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="2d2a5-132">另請參閱</span><span class="sxs-lookup"><span data-stu-id="2d2a5-132">See Also</span></span>  
 [<span data-ttu-id="2d2a5-133">設定 BizTalk Server</span><span class="sxs-lookup"><span data-stu-id="2d2a5-133">Configure BizTalk Server</span></span>](../install-and-config-guides/configure-biztalk-server.md)   