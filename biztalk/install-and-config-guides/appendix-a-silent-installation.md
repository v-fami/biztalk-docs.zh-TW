...
|/L|\<記錄檔 > [i] [w] [e] [a] [r] [u] [c] [m] [p] [v] [*]|將記錄資訊寫入指定路徑的記錄檔。 一律使用詳細的 Windows Installer 記錄，並附加到現有的檔案。<br /><br /> 下列旗標指出會記錄的資訊：<br /><br /> i - 狀態訊息<br /><br /> w - 非嚴重警告<br /><br /> e - 所有錯誤訊息<br /><br /> a - 啟動動作<br /><br /> r - 特定動作記錄<br /><br /> u - 使用者要求<br /><br /> c - 初始使用者介面參數<br /><br /> m - 記憶體不足<br /><br /> p - 終端機內容<br /><br /> v – 詳細資訊輸出<br /><br /> * - 全部|  
