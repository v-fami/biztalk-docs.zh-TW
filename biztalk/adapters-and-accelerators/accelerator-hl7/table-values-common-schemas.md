...
[!INCLUDE[btsCoName](../../includes/btsconame-md.md)]BizTalk Accelerator for HL7 ([!INCLUDE[btaBTAHL71.3abbrevnonumber](../../includes/btabtahl71-3abbrevnonumber-md.md)]) 會產生 **tablevalues_*\<版本\>*.xsd * * 如需每個 HL7 版本中，檔案中，並找出根目錄的檔案HL7 特定版本的資料夾。 資料類型通用的結構描述檔案參考的資料表值 common 結構描述檔案。  
