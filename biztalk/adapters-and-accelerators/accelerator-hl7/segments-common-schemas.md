...
```  
 ...
 其中*xxx*是訊息類型，  *nnn* 是觸發程序的事件， *vaa*是版本號碼，GLO 指出全球化，和 DEF 表示預設值。 結構描述檔案 *\<xxx\>*_*\<nnn\>*\_*\<vaa\>*  \_  *\<glo\>*\_*\<def\>*.xsdis 從產生EventMessageTypeSegments 和 SegmentDataElements 存取資料庫資料表和包含之線段的指標\_\<*版本*\>.xsd 結構描述檔案。  
