...
## <a name="btahl7-configuration-explorer"></a>BTAHL7 組態總管  
 與[!INCLUDE[btaBTAHL71.3abbrevnonumber](../../includes/btabtahl71-3abbrevnonumber-md.md)]組態總管 中，您可以檢閱並設定批次定義、 通知組態和記錄資料存放區設定。 使用[!INCLUDE[btaBTAHL71.3abbrevnonumber](../../includes/btabtahl71-3abbrevnonumber-md.md)]組態總管 中，您可以 initiative 啟用、 要求和處理合作對象層級的批次終止。  
