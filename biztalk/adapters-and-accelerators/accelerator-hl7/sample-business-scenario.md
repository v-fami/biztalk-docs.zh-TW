...
## <a name="the-btahl7-solution"></a>BTAHL7 方案  
 以上所述的範例商務案例是需要整合醫療保健系統的範例。 [!INCLUDE[btsCoName](../../includes/btsconame-md.md)]BizTalk Server 與[!INCLUDE[btsCoName](../../includes/btsconame-md.md)]BizTalk Accelerator for HL7 ([!INCLUDE[btaBTAHL71.3abbrevnonumber](../../includes/btabtahl71-3abbrevnonumber-md.md)]) 提供此功能的下列功能的案例的解決方案：  
