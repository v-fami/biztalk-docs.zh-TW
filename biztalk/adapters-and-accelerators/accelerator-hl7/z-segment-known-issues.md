...
---
# <a name="z-segment-known-issues"></a>Z 區段已知的問題
本節包含可協助您避免 Z 區段錯誤的有用資訊。  
  
## <a name="characters-not-recommended-to-use-for-naming-z-segments"></a>不建議用於命名 Z 區段的字元  
 建議您務必 HL7 區段名稱並可能會造成錯誤命名 Z 區段使用下列字元：  
