...
3.  在命令提示字元中，輸入 **mllpreceive/p 41000 /sb 11 /eb 28 /cr 13 /hl7ack"\<*磁碟機*\>: \Program Files\Microsoft BizTalk\<版本\>做 HL7\Samples\Sample 應用程式接受 ACK.txt**，然後按下快速鍵**Enter**。 在命令提示字元視窗會進入等候狀態，直到您執行步驟 5 及系統接收輸入。  
