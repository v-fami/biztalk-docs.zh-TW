...
---
# <a name="fileact-store-and-forward-scenario"></a>FileAct 存放與轉寄的案例
開始在此案例中的步驟之前，您必須完成[準備使用本教學課程](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md)。  
