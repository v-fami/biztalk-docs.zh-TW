...
---
# <a name="step-3a-create-an-orchestration-for-dynamic-send-port-for-fileact-store-and-forward-pull-scenario"></a>步驟 3A： 建立 FileAct 存放與轉寄 （提取） 案例的動態傳送埠的協調流程
開始本節中的步驟之前，您必須完成的步驟[步驟 2c： 新增 FILEACT 傳送埠 FileAct 儲存和轉送 （提取） 案例](../../adapters-and-accelerators/fileact-interact/step-2c-add-a-fileact-send-port-for-fileact-store-and-forward-pull-scenario.md)> 一節。  
