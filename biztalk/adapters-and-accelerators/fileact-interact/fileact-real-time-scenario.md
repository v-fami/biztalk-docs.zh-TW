...
---
# <a name="fileact-real-time-scenario"></a>FileAct 即時案例
開始進行這個案例之前，必須先完成[準備使用本教學課程](../../adapters-and-accelerators/fileact-interact/preparing-to-use-the-tutorial1.md)。  
