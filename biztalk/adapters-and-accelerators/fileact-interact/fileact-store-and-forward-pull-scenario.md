...
-   [步驟 1： 設定 FileAct 存放與轉寄 （提取） 案例的 SWIFT 配接器](../../adapters-and-accelerators/fileact-interact/step-1-configure-the-swift-adapter-for-fileact-store-and-forward-pull-scenario.md)
