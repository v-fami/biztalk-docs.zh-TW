...
---
# <a name="step-3-create-send-and-receive-ports-for-the-interact-real-time-scenario"></a>步驟 3： 建立傳送和接收埠互動即時案例
如需 BizTalk Server 傳送和接收埠和接收位置，請參閱[管理成品](../../core/managing-artifacts.md)BizTalk Server 文件中。  
  
## <a name="steps-in-this-section"></a>本節中的步驟
