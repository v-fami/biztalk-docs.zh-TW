...
ms.locfileid: "22223806"
---
# <a name="step-4-test-fileact-store-and-forward-pull-end-to-end-scenario"></a>步驟 4： 測試 FileAct 存放與轉寄 （提取） 的端對端案例
完成中的步驟[步驟 3B: FileAct 存放與轉寄 （提取） 案例的動態傳送埠與協調流程繫結](../../adapters-and-accelerators/fileact-interact/step-3b-bind-orchestration-with-dynamic-send-for-fileact-store-and-forward.md)開始本節中的步驟之前。
