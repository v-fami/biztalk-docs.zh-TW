...
---
# <a name="step-4-test-the-interact-store-and-forward-end-to-end-scenario"></a>步驟 4： 測試互動存放區和轉寄的端對端案例
開始本節中的步驟之前，您必須完成[步驟 3D： 新增為互動存放與轉寄實例互動傳送埠](../../adapters-and-accelerators/fileact-interact/step-3d-add-an-interact-send-port-for-the-interact-store-and-forward-scenario.md)。  
