...
---
# <a name="adapter-samples"></a>配接器範例
[!INCLUDE[btsCoName](../../includes/btsconame-md.md)]® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] 在它的軟體開發套件 (SDK) 中包含幾個配接器範例。 本節提供每個配接器範例所展示功能的詳細資訊、用來建置和執行範例的指示，以及您可以預期的結果。  
