...
## <a name="features-and-tools"></a>功能與工具  
 ...
 [!INCLUDE[btsCoName](../../includes/btsconame-md.md)] Management Console (MMC) 裝載 IT 專業人員的工具。 介面分析師、IT 實作者以及 IT 操作員，透過 MMC 架構的 BizTalk 管理主控台、BizTalk 總管、[!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] 管理主控台及其他執行階段工具來管理他們的 [!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] 系統。  
