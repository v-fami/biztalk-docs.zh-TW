...
3.  在命令提示字元中，輸入**CScript InstallDTD.vbs**，然後按下**Enter**。  
    ...
    > [!NOTE]
    >  一旦安裝 [!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)] 之後，您只需要執行步驟 1 到 3 即可。  
  
4.  啟動 [!INCLUDE[vs2012](../../includes/vs2012-md.md)]。  
...
9. 啟動[!INCLUDE[vs2012](../../includes/vs2012-md.md)]命令提示字元。  
...
19. 在**加入參考**對話方塊中，按一下 **瀏覽**，並移至\<*磁碟機*>: \Program Files\\ [!INCLUDE[btsCoName](../../includes/btsconame-md.md)] BizTalk 2013Accelerator for RosettaNet\Bin，然後選取**Microsoft.Solutions.BTARN.Schemas.RNPIPs.dll**。 按一下**開啟**，然後按一下**確定**。  
...
30. 在**BizTalk 型別選擇器**對話方塊方塊中，展開  \<*專案名稱*>，展開 **參考**，依序展開**Microsoft.Solutions.BTARN.Schemas.RNPIPs**，依序展開**結構描述**，選取**Microsoft.Solutions.BTARN.Schemas.RNPIPs.BaseDataTypes**，按一下  **確定**，然後按一下**確定**一次。  
