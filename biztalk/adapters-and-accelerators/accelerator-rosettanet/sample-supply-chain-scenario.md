...
## <a name="the-players"></a>交易夥伴  
 ...
 銷售商是一家中型的高效能積體電路 (IC) 供應商。 它們目前通訊與交易夥伴使用電話、 傳真、 電子郵件與附加 Microsoft[!INCLUDE[btsExcel](../../includes/btsexcel-md.md)]試算表、 FTP 和 Web 應用程式。 銷售商並未使用 EDI。 他們與每個交易夥伴互動的方式皆有所不同，視客戶的需要以及他們自有的技術而定。 他們希望商務程序能更有效率，以降低交易成本、加強客戶滿意度及取得競爭優勢。  
