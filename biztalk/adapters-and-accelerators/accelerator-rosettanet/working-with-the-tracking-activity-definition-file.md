...
1.  按一下 **[開始]**，然後按一下 **[執行]**。 輸入**cmd**中開啟 文字方塊中，執行 對話方塊中，然後再按一下**確定**。 在命令列 對話方塊中，輸入下列程式碼以解除部署 tracking.xml，然後按一下**確定**:  
...
5.  部署新的追蹤 XML 檔案。 若要這樣做，請按一下**啟動**，然後按一下 **執行**。 輸入**cmd**中開啟 文字方塊中，執行 對話方塊中，然後再按一下**確定**。 在命令列 對話方塊中，輸入下列程式碼，以部署新的追蹤檔案，然後按一下**確定**。 建議您最好修改此追蹤 XML 檔案的名稱，以免覆寫預設的 tracking.xml 檔案。  
