...
---
# <a name="about-the-rosettanet-accelerator"></a>關於 RosettaNet 加速器
[!INCLUDE[btsCoName](../../includes/btsconame-md.md)]® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] 是完備的解決方案，可以在採用 RosettaNet 標準的高科技製造電腦應用程式之間交換資料。 請使用本文件組，熟悉 [!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] 的服務、性能及功能。  
...
-   [BizTalk Accelerator for RosettaNet 的運作方式](../../adapters-and-accelerators/accelerator-rosettanet/how-biztalk-accelerator-for-rosettanet-works.md)  
