...
---
# <a name="programming-guide-tools-and-samples-in-the-rosettanet-sdk"></a>程式設計手冊、 工具和 RosettaNet SDK 中的範例
此軟體開發套件 (SDK) 會針對使用 [!INCLUDE[btsCoName](../../includes/btsconame-md.md)]® [!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)] 中任一工具、公用應用程式發展介面 (API) 或 [!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] SDK 中提供之範例和公用程式來建立應用程式的開發人員，提供一些相關資訊。  
