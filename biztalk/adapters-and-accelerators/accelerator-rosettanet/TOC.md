...
#### [步驟 2：建立交易夥伴組織](step-2-create-the-partner-organization.md)
...
##### [步驟 2：建立公開憑證與私用憑證](step-2-creating-public-and-private-certificates.md)
##### [步驟 3：匯入公開憑證與私用憑證](step-3-importing-public-and-private-certificates.md)
##### [步驟 4：在 IIS 中啟用安全通訊端層 (SSL)](step-4-enabling-secure-sockets-layer-in-iis.md)
...
##### [步驟 2：建立 Fabrikam 交易夥伴組織](step-2-creating-the-fabrikam-partner-organization.md)
...
##### [步驟 7：建置與部署 DoubleAction SDK 範例](step-7-building-and-deploying-the-doubleaction-sdk-sample.md)
...
##### [步驟 7：建置與部署 LOBWebApplication SDK 範例](step-7-building-and-deploying-the-lobwebapplication-sdk-sample.md)
...
###### [步驟 1：將現有的 BizTalk 專案新增至現有的 Contoso 解決方案](step-1-adding-an-existing-biztalk-project-to-the-existing-contoso-solution.md)
###### [步驟 2：定義與發佈 Contoso 的詞彙](step-2-defining-and-publishing-the-vocabulary-for-contoso.md)
###### [步驟 3：定義、發佈與部署 Contoso 的商務原則](step-3-defining-publishing-and-deploying-the-business-policy-for-contoso.md)
...
###### [步驟 7：建立與設定連接埠](step-7-creating-and-configuring-ports.md)
###### [步驟 8：建立與部署 Contoso 協調流程](step-8-building-and-deploying-the-contoso-orchestration.md)
