...
---
# <a name="enhanced-tracking"></a>加強的追蹤
Microsoft[!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)]提供追蹤程序和訊息的加強的功能。 針對商務活動監控 (BAM) 中的原生功能[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]在於追蹤僅限中繼資料。 [!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] 追蹤訊息內容 — 服務內容和標頭。  
...
## <a name="process-and-message-tracking"></a>程序和訊息追蹤  
 [!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)] 會追蹤兩個基本活動： 程序活動和訊息活動。 程序活動追蹤在公開程序協調流程中處理的訊息； 訊息活動則是追蹤在傳送或接收管線中處理的訊息。  
...
### <a name="tracking-databases"></a>追蹤資料庫  
 ...
 您可以使用下列檢視取用 BAMPrimaryImport 追蹤資料庫中的資料。 這些和其他檢視可在 Microsoft[!INCLUDE[btsSQLServerNoVersion](../../includes/btssqlservernoversion-md.md)]節點[!INCLUDE[btaBTARN3.3abbrevnonumber](../../includes/btabtarn3-3abbrevnonumber-md.md)]管理主控台。  
...
|35|ReceivedActionSignal2 或 SentActionSignal2<br /> （signal 2 適用於 RNIF v11）|  
|50|ReceivedResponse 或 SentResponse|  
|75|ReceivedResponseSignal 或 SentResponseSignal|  
|85|ReceivedResponseSignal2 或 SentResponseSignal2<br /> （signal 2 適用於 RNIF v11）|  
|100|ActivityCompleted|  

### <a name="activity-definition-file"></a>活動定義檔  
 活動定義檔案會定義您在 BAM 中追蹤的欄位以及檢視欄位的方式。 如需有關這個檔案的詳細資訊，請參閱 <<c0> [ 使用追蹤活動定義檔案](../../adapters-and-accelerators/accelerator-rosettanet/working-with-the-tracking-activity-definition-file.md)。  
