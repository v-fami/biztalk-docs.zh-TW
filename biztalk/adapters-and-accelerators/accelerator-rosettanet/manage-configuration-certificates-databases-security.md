...
本節提供概念和程序的資訊，可讓您有效地設定、 監視及維護您[!INCLUDE[BTARN_CurrentVersion_FirstRef](../../includes/btarn-currentversion-firstref-md.md)]應用程式環境。  
...
-   [保護傳送者 ASPX 頁面](../../adapters-and-accelerators/accelerator-rosettanet/securing-the-sender-aspx-page.md)  
  
-   [對抗阻絕服務攻擊](../../adapters-and-accelerators/accelerator-rosettanet/defending-against-denial-of-service-attacks.md)  
