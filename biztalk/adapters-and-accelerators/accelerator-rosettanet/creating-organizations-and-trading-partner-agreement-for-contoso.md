...
-   [<span data-ttu-id="7a689-108">步驟 1： 建立 Contoso 主要組織</span><span class="sxs-lookup"><span data-stu-id="7a689-108">Step 1: Creating the Contoso Home Organization</span></span>](../../adapters-and-accelerators/accelerator-rosettanet/step-1-creating-the-contoso-home-organization.md)  
  
-   [<span data-ttu-id="7a689-109">步驟 2： 建立 Fabrikam 交易夥伴組織</span><span class="sxs-lookup"><span data-stu-id="7a689-109">Step 2: Creating the Fabrikam Partner Organization</span></span>](../../adapters-and-accelerators/accelerator-rosettanet/step-2-creating-the-fabrikam-partner-organization.md)  
  
-   [<span data-ttu-id="7a689-110">步驟 5： 建立 Contoso 3A2 交易夥伴協議</span><span class="sxs-lookup"><span data-stu-id="7a689-110">Step 5: Creating the Contoso 3A2 Trading Partner Agreement</span></span>](../../adapters-and-accelerators/accelerator-rosettanet/step-5-creating-the-contoso-3a2-trading-partner-agreement.md)  
  
> [!IMPORTANT]
>  <span data-ttu-id="7a689-111">這些都是「雙向動作」教學課程中的步驟。</span><span class="sxs-lookup"><span data-stu-id="7a689-111">These steps are in the Double Action Tutorial.</span></span> <span data-ttu-id="7a689-112">當您完成上述每個步驟之後，請返回本主題繼續進行「私用程序」教學課程。</span><span class="sxs-lookup"><span data-stu-id="7a689-112">After completing each step, return to this topic to continue the Private Process Tutorial.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="7a689-113">另請參閱</span><span class="sxs-lookup"><span data-stu-id="7a689-113">See Also</span></span>  
 [<span data-ttu-id="7a689-114">建立 Contoso LOB 結構描述與對應</span><span class="sxs-lookup"><span data-stu-id="7a689-114">Creating the Contoso LOB Schemas and Maps</span></span>](../../adapters-and-accelerators/accelerator-rosettanet/creating-the-contoso-lob-schemas-and-maps.md)