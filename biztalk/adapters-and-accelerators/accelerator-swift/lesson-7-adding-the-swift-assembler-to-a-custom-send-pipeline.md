...
### <a name="to-add-the-swift-assembler-pipeline-component-to-the-pipeline"></a>若要新增 SWIFT 組合器管線元件至管線  
  
1.  在**BizTalk 管線元件 [工具箱]**，拖曳**SWIFT 組譯工具**至**放置到此處**下列方塊**組合**中的圖形**BizTalk 管線設計師**。  
  
2.  在**檔案**功能表上，選取**全部儲存**以儲存變更。  
  
 若要繼續[第 9 課： 建立和部署組件](../../adapters-and-accelerators/accelerator-swift/lesson-8-building-and-deploying-the-assembly.md)。