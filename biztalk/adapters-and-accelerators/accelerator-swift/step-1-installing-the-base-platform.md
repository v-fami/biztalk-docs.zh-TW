...
-   請確定您已安裝所需的所有軟體必要條件[!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]安裝。 如需詳細資訊，請參閱 BizTalk Server 的安裝指示，在[http://go.microsoft.com/fwlink/?LinkId=81041](http://go.microsoft.com/fwlink/?LinkId=81041)。 [BizTalk 2013 R2 Accelerator for SWIFT 的安裝指南 》](http://msdn.microsoft.com/library/d2b4a9f3-baeb-4fbc-9fda-5e4178832cd1)。  
  
-   離線的環境中測試所有重大更新，然後再將它們安裝在實際執行伺服器上。  
  
-   請確定您已安裝所有適用的 hotfix 安裝為部署的一部分的所有產品。 如需詳細資訊，請參閱下列來源：  
  
    -   [!INCLUDE[btsCoName](../../includes/btsconame-md.md)][!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]線上說明  
