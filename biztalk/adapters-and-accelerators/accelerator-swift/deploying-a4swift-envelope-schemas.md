...
7.  在 [新增現有的項目] 對話方塊中**查看**下拉式清單方塊中，移至**\<磁碟機 >: files\ Microsoft BizTalk Accelerator for SWIFT\<版本 > 郵件 Pack\SWIFT 訊息\A4SWIFT-SRG\<版本 > \Categoryn\MTxxx**。 例如，選取信封結構描述， **EnvelopeMT103.xsd**，然後按一下 **新增**。  
