...
[!INCLUDE[btsCoName](../../includes/btsconame-md.md)][!INCLUDE[A4SWIFT_CurrentVersion_FirstRef](../../includes/a4swift-currentversion-firstref-md.md)]提供兩種形式的功能： 開發資料和執行階段元件。 開發材料包括 XSD 結構描述，驗證規則和原則和範例程式碼。 執行階段元件包括自訂 SWIFT 解譯器、 自訂 SWIFT 組譯工具、 Message Repair 和 New Submission 協調流程 (MrsrRepair.odx) 和 FIN 回應對帳協調流程 (FrrMain.odx)。 如需有關 Message Repair 和 New Submission 的詳細資訊，請參閱[Message Repair 和 New Submission](../../adapters-and-accelerators/accelerator-swift/message-repair-and-new-submission.md)。 如需有關 FRR 的詳細資訊，請參閱[FIN 回應對帳](../../adapters-and-accelerators/accelerator-swift/fin-response-reconciliation.md)。  
 ...
 您可以定義所有 A4SWIFT 元件為垂直專屬實作[!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]應用程式元件。 BizTalk 「 加速器 」 提供開發和執行階段以加速上方的垂直特定 BizTalk 應用程式開發功能[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]。 因此，遵守，所有的 A4SWIFT 元件 （開發或執行階段），以及納入，[!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]應用程式架構。 A4SWIFT 安裝到執行階段元件[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]做為自訂元件的執行階段。 在開發之後材料編譯和部署，A4SWIFT 和[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]執行階段使用它們來提供 SWIFT 訊息和自動化功能。  
  
 如下圖所示的高階應用程式拓樸[!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]。  
  
 ![](../../adapters-and-accelerators/accelerator-swift/media/fsa-intro1.gif "FSA_Intro1")  
  
 [!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]應用程式模型使用的 MessageBox 資料庫和管理訊息流程進出 MessageBox 資料庫的發行者訂閱者模式。 如需 BizTalk 架構和應用程式設計的詳細資訊，請參閱[!INCLUDE[btsBizTalkServer2006r3](../../includes/btsbiztalkserver2006r3-md.md)]幫助。  
...
-   [SWIFT 反組譯工具](../../adapters-and-accelerators/accelerator-swift/swift-disassembler.md)  
  
-   [SWIFT 組譯工具](../../adapters-and-accelerators/accelerator-swift/swift-assembler.md)  
  
-   [正在提交訊息到接收位置和 InfoPath 表單](../../adapters-and-accelerators/accelerator-swift/submitting-messages-through-receive-locations-and-infopath-forms.md)  
