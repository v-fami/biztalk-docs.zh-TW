...
> [!IMPORTANT]
>  [!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)]可從屬於[!INCLUDE[adapterpacknoversion](../../includes/adapterpacknoversion-md.md)]以及個別的配接器。 如果您要存取本主題來了解與安裝問題[!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)]，為分開[!INCLUDE[adapterpacknoversion](../../includes/adapterpacknoversion-md.md)]，所有參考[!INCLUDE[adapterpacknoversion](../../includes/adapterpacknoversion-md.md)]安裝程式必須解譯為[!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)]安裝程式。  
...
3. 若要註冊[!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)]繫結：  
   ...
   3. 尋找遺漏[!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)]繫結。 新增"bindingElementExtensions 」 節點的下一節。  
   ...
   5. 尋找遺漏[!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)]繫結。 新增"bindingExtensions 」 節點的下一節。  
...
2. 以滑鼠右鍵按一下，想要的公開金鑰和版本，並選取您的 DLL**屬性**。 下表列出的 DLL 名稱[!INCLUDE[adaptersqlshort](../../includes/adaptersqlshort-md.md)]。  
...
###  <a name="BKMK_SQLConsumeBinding"></a> 使用 64 位元安裝上的 取用配接器服務增益集或加入配接器服務參考外掛程式時發生錯誤  
 **問題**  
...
###  <a name="BKMK_SQLInvalidBinding"></a> 在 BizTalk Server 管理主控台中設定 SQL 配接器連接埠，在 64 位元安裝上時無效的繫結錯誤  
 **問題**  
