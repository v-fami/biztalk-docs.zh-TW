...
|作業|訊息的動作|範例|  
|---------------|--------------------|-------------|  
|Insert|TableOp/Insert / [SCHEMA] / [TABLE_NAME]|TableOp/Insert/dbo/所有員工|  
|插入回應|TableOp/Insert / [SCHEMA] / [TABLE_NAME] / 回應|TableOp/Insert/dbo/Employee/回應|  
|Select|TableOp/Select / [SCHEMA] / [TABLE_NAME]|TableOp/Select/dbo/所有員工|  
|選取回應|TableOp/Select / [SCHEMA] / [TABLE_NAME] / 回應|TableOp/Select/dbo/Employee/回應|  
|Update|TableOp/更新 / [SCHEMA] / [TABLE_NAME]|TableOp/更新/dbo/所有員工|  
|更新回應|TableOp/更新 / [SCHEMA] / [TABLE_NAME] / 回應|TableOp/更新/dbo/Employee/回應|  
|DELETE|TableOp/刪除 / [SCHEMA] / [TABLE_NAME]|TableOp/刪除/dbo/所有員工|  
|刪除回應|TableOp/刪除 / [SCHEMA] / [TABLE_NAME] / 回應|TableOp/刪除/dbo/Employee/回應|  
