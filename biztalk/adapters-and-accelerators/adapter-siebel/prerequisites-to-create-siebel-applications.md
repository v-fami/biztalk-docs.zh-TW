...
您必須執行在開發 BizTalk 應用程式使用之前[!INCLUDE[adaptersiebel_short](../../includes/adaptersiebel-short-md.md)]。 本主題也會列出一些用來開發 BizTalk 應用程式的 BizTalk Server 工具。  
