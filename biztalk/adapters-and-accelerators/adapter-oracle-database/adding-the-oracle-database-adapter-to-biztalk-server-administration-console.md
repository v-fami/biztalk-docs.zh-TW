...
## <a name="add-the-oracle-database-adapter"></a>將 Oracle 資料庫配接器  
...
4. 在 **配接器屬性**對話方塊方塊中，輸入名稱，配接器，並從**配接器**清單中，選取**Wcf-oracledb**。  
  
    ![新增 WCF&#45;OracleDB 配接器至 BizTalk Server](../../adapters-and-accelerators/adapter-oracle-database/media/wcf-oracledb.gif "WCF_OracleDB")  
