...
##  <span data-ttu-id="d3f6a-132"><a name="Custom_Web_Part"></a>包含自訂 Web 組件的問題</span><span class="sxs-lookup"><span data-stu-id="d3f6a-132"><a name="Custom_Web_Part"></a> Issues Involving Custom Web Parts</span></span>  
...
###  <span data-ttu-id="d3f6a-135"><a name="Issue1"></a>問題 1： 與 Microsoft Office SharePoint Server 中顯示單一記錄限制根據多個值</span><span class="sxs-lookup"><span data-stu-id="d3f6a-135"><a name="Issue1"></a> Issue 1: Limitation with displaying a single record in Microsoft Office SharePoint Server based on multiple values</span></span>  
