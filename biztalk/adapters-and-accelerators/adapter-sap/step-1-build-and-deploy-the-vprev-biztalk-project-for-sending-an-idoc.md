...
---
# <a name="step-1-build-and-deploy-the-vprev-biztalk-project-for-sending-an-idoc"></a>步驟 1： 建立和部署傳送 IDOC vPrev BizTalk 專案
![步驟 3 之 1](../../adapters-and-accelerators/adapter-oracle-database/media/step-1of3.gif "Step_1of3")  
  
 **若要完成的時間：** 5 分鐘  
  
 **目標：**在此步驟中，您要建置和部署現有的 vPrev BizTalk 專案，以傳送 IDOC 至 SAP 系統。  
  
> [!NOTE]
>  您不需要進行任何變更 vPrev BizTalk 專案。  
  
## <a name="prerequisites"></a>必要條件  
 您必須傳送 BOMDOC IDOC 到 SAP 系統 vPrev BizTalk 專案。  
...
2.  以滑鼠右鍵按一下方案總管 中的 BizTalk 方案名稱，然後按一下**屬性**。 在**屬性頁**對話方塊方塊中，執行下列動作：  
    ...
    1.  從左窗格中，按一下 組態屬性，並確定核取方塊後**建置**和**部署**選取資料行。  
...
## <a name="next-steps"></a>後續步驟  
 建立和設定 Wcf-custom 傳送埠，並將它設定為傳送 Idoc 至 SAP 系統使用 WCF 型[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]中所述，[步驟 2： 設定 Wcf-custom 單向傳送埠](../../adapters-and-accelerators/adapter-sap/step-2-configure-a-wcf-custom-one-way-send-port.md)。  
