...
---
# <a name="sap-adapter-tutorials"></a>SAP 配接器教學課程
## <a name="overview"></a>概觀
中的第一個[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]教學課程包含如何呈現在 Microsoft SharePoint 入口網站上的 SAP 系統的資料的逐步示範。 其餘部分[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]教學課程包含有關如何移轉使用 SAP 配接器目前舊版所建立的 BizTalk 專案的詳細的指示 WCF 架構[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]。  
  
 除了教學課程中的主題[開發 BizTalk 應用程式](../../adapters-and-accelerators/adapter-sap/develop-biztalk-applications-using-the-sap-adapter.md)> 一節會詳細的說明如何使用[!INCLUDE[adaptersap_short](../../includes/adaptersap-short-md.md)]與[!INCLUDE[btsBizTalkServerNoVersion](../../includes/btsbiztalkservernoversion-md.md)]。  
