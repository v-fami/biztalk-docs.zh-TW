...
##### [步驟 4：測試 SharePoint 應用程式](step-4-test-your-sharepoint-application1.md)
...
##### [步驟 2：在 BizTalk Server 管理主控台設定協調流程](step-2-configure-the-orchestration-in-biztalk-server-administration-console1.md)
