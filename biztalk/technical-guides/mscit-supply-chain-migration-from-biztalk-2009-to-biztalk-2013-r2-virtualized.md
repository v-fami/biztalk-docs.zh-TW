 ...
 **適用於**: BizTalk Server 2013 R2  
  
 **摘要**： 描述的原因，以及由 Microsoft IT 應用程式從 BizTalk Server 2009 和 2010年移轉至 BizTalk Server 2013 R2 移轉程序。 MSIT 識別訊息資料流、 轉換 Visual Studio 中的 BizTalk 專案、 移動交易夥伴管理合作對象和協議，和更新應用程式繫結。  
  
 您也可以閱讀 MSIT 面臨的挑戰和使用的最佳作法。  
  
 下載[BizTalk Server 2013 R2 從 BizTalk Server 2009/2010 MSIT 移轉劇本](http://download.microsoft.com/download/6/D/E/6DEE8EE9-0F26-4991-8FE5-B0E5239C0980/MSIT-Whitepaper%20Migration%20Story%20BizTalk%202013%20R2.docx)白皮書。