...
|檔案名稱|顯示名稱|Description|  
|---------------|------------------|-----------------|  
|Microsoft.BizTalkServer2013.Library.mp|BizTalk Server 文件庫|包含泛型類別、 關聯性和其他管理組件用於提供監視所有的 BizTalk 應用程式的其他管理組件建置組塊。|  
|Microsoft.BizTalk.Server.2013.Monitoring.mp|BizTalk Server 監控|包含監視、 規則和提供 「 可延伸的方式控制所有的 BizTalk 應用程式的檢視。|  
|Microsoft.BizTalk.Server.2013.Discovery.mp|BizTalk Server 探索|包含用來尋找 BizTalk 應用程式的各種元件的探索。|