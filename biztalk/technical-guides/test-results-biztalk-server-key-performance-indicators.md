 ...
 **BizTalk Server 關鍵效能指標 – 比較**執行[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]上 HYPER-V 虛擬機器提供約 95%的輸送量和延遲效能[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]此測試案例的實體硬體上。 由於無狀態的本質之故[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]額外[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]虛擬機器可以輕鬆地新增到環境為必要項目來提供向外的延展，並增加系統的整體效能。 建立並加入其他[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]環境，可透過使用 sysprep 公用程式來產生新的映像的基底映像。  
  
> [!NOTE]  
>  Sysprep 回應檔案和指令碼所提供的[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]以配合從現有的已在電腦映像建立額外的映像使用 sysprep[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]安裝。 這些範例指令碼專為搭配[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]32 位元和 64 位元版本的 Windows Server 2008 上安裝。 如需詳細資訊，請參閱[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]線上文件。  
 ...
 取得在這個實驗室中的效能結果會顯示標示為從執行時所獲得的效能改進[!INCLUDE[btsbiztalkserver2006r2](../includes/btsbiztalkserver2006r2-md.md)]上[!INCLUDE[btsWinSvr2k3](../includes/btswinsvr2k3-md.md)]在 HYPER-V 虛擬機器。 執行[!INCLUDE[btsbiztalkserver2006r2](../includes/btsbiztalkserver2006r2-md.md)]上 HYPER-V 虛擬機器提供約 75%的輸送量和延遲效能[!INCLUDE[btsbiztalkserver2006r2](../includes/btsbiztalkserver2006r2-md.md)]與實體硬體上執行時，觀察到 95%的效能大約[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]和[!INCLUDE[btsWinSvr2k8](../includes/btswinsvr2k8-md.md)]在 HYPER-V 虛擬機器。 這種效能提升是主要是能歸因於改善的效能[!INCLUDE[btsWinSvr2k8](../includes/btswinsvr2k8-md.md)]HYPER-V 上做為客體作業系統執行時。 從相關的效能比較[!INCLUDE[btsbiztalkserver2006r2](../includes/btsbiztalkserver2006r2-md.md)]HYPER-V 指南將會位於[http://go.microsoft.com/fwlink/?LinkId=147144](http://go.microsoft.com/fwlink/?LinkId=147144)。  
  
 下圖所示範的效能[!INCLUDE[btsBizTalkServer2006r3](../includes/btsbiztalkserver2006r3-md.md)]需各種測試平台：  
