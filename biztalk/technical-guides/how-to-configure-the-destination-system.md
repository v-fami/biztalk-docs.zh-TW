...
---
# <a name="how-to-configure-the-destination-system"></a>如何設定目的系統
如需設定目的系統以進行記錄傳送的資訊，請參閱[如何設定記錄傳送目的地系統](http://go.microsoft.com/fwlink/?LinkId=151402)(http://go.microsoft.com/fwlink/?LinkId=151402) 在 BizTalk Server 說明中。  
