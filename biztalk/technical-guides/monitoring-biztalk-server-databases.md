...
---
# <a name="monitoring-biztalk-server-databases"></a>監視 BizTalk Server 資料庫
...
> [!IMPORTANT]  
>  這項作業失敗不一定是構成重要的問題，但相反地，應該調查和解決一部分的 BizTalk Server 資料庫的定期維護的問題。 萬一它會探索其中一個上述問題，這項作業會失敗所設計。