...
-   [監視管理組件的 BizTalk Server 2010](ttp://go.microsoft.com/fwlink/?LinkId=210666) (ttp://go.microsoft.com/fwlink/?LinkId=210666)。  
  
 操作指南的這個章節包括背景資訊、 最佳做法、 檢查清單和您可以使用以協助實作根據 Operations Manager 監視策略的程序。  
...
-   [監視應用程式和主控件執行個體](../technical-guides/monitoring-applications-and-host-instances.md)