...
可以設定路線服務的協調流程子系統或傳訊子系統中發生[!INCLUDE[prague](../includes/prague-md.md)]。 這些 ESB 路線傳訊服務設定來處理訊息，而且可能會在 BizTalk Server 管線 （上手或匝道） 中執行。 此選項可讓開發人員定義完全在管線中將執行服務。 當然，設定為協調流程子系統中的程序服務將會執行 BizTalk 協調流程中。  
