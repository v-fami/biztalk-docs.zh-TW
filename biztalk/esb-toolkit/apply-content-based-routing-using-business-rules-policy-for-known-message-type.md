...
1.  在 RouteBasedOnCustomerKnownType 原則中，以滑鼠右鍵按一下 1.0 版 （未儲存），然後按一下新增規則。 命名規則 SetUnknownCustomerEndpoint。  
  
2.  在 [規則] 視窗中，以滑鼠右鍵按一下條件，，然後按一下新增邏輯 and。  
  
3.  在 規則 視窗中，以滑鼠右鍵按一下，指向 述詞，且然後按一下不等於。  
...
7.  在 規則 視窗中，以滑鼠右鍵按一下，指向 述詞，且然後按一下不等於。  
