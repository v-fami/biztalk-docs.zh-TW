 ...
 **AmberPoint 元件安裝到傳送管線**  
  
 此外，AmberPoint 隨附四個預先定義的管線，您可以直接繫結至現有的接收位置和傳送埠使用 BizTalk 管理主控台。 圖 2 顯示給配接器的接收管線的繫結。  
  
 ![繫結 AmberPoint](../esb-toolkit/media/ch9-bindingamberpoint.jpg "Ch9 BindingAmberPoint")  
