...
---
# <a name="xml-for-a-salesorder-session"></a>SalesOrder 工作階段的 XML
下面幾節將提供 SalesOrder 工作階段的 XML 範例。  
  
## <a name="begindoc-xml-sample"></a>BeginDoc XML 範例  
...
## <a name="editline-xml-sample"></a>EditLine XML 範例  
...
## <a name="enddoc-xml-sample"></a>EndDoc XML 範例  
