...
---
# <a name="how-to-disable-a-receive-location"></a>如何停用接收位置
本主題描述如何使用 BizTalk Server 管理主控台來停用接收位置。 停用接收位置時，它就會停止接收訊息。 如有需要，在停用接受位置之後，您還是可以再啟用它，它就會再次接收訊息。  
...
### <a name="to-disable-a-receive-location"></a>停用接收位置  
  
1.  按一下**啟動**，按一下 **所有程式**，按一下  [!INCLUDE[btsBizTalkServerStartMenuItemui](../includes/btsbiztalkserverstartmenuitemui-md.md)]，然後按一下  **BizTalk Server 管理**。  
  
2.  在主控台樹狀結構中，展開您要停用其接收位置的 BizTalk 群組和 BizTalk 應用程式。  
  
3.  按一下**接收位置**，接收位置，以滑鼠右鍵按一下，然後按一下**停用**。  
  
## <a name="see-also"></a>另請參閱  
 [管理接收位置](../core/managing-receive-locations.md)   
 [如何啟用接收位置](../core/how-to-enable-a-receive-location.md)