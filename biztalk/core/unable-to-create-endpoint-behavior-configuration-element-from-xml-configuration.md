...
---
# <a name="unable-to-create-endpoint-behavior-configuration-element-from-xml-configuration"></a>無法從 XML 設定建立端點行為組態項目
...
|    元件    |                                         0                                          |
|  符號名稱  |                                         0                                          |
|  訊息文字   |  無法從 XML 設定建立端點行為組態項目   |

## <a name="explanation"></a>說明  
 此錯誤表示配接器未載入的端點行為組態。 主要使用 Wcf-custom 和 Wcf-customisolated 配接器，就會發生這種情況。  
