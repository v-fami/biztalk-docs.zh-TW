...
---
# <a name="unable-to-create-endpoint-behavior-configuration-element-from-xml-configuration"></a>無法從 XML 組態建立端點行為組態項目
...
|元件|0|  
|符號名稱|0|  
|訊息文字|無法從 XML 組態建立端點行為組態項目|  
  
## <a name="explanation"></a>說明  
 此錯誤表示配接器不會載入的端點行為組態。 主要是搭配 Wcf-custom 和 Wcf-customisolated 配接器，就會發生這種情況。  
  
## <a name="user-action"></a>使用者動作  
 您可以使用下列程序來設定端點行為。  
  
#### <a name="to-configure-the-endpoint-behavior"></a>若要設定的端點行為  
...
9. 在**行為**區段中，按一下 **[endpointbehavior]** 組態。