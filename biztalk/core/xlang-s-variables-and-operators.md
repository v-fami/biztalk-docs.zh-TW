...
---
# <a name="xlang-s-variables-and-operators"></a>Xlang-s 變數和運算子
...
- 辨別內建實值型別：**布林**，**位元組**， **Char**， **Decimal**， **Double**， **Int16**， **Int32**， **Int64**， **SByte**，**單一**，**字串**，**UInt16**， **UInt32**，和**UInt64**  
...
|succeeded|測試交易式範圍或協調流程是否順利完成|成功 (\<的子交易的目前範圍或服務的交易識別碼\>)|  
