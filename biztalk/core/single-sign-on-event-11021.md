...
|訊息文字|外部密碼變更將造成不同的外部帳戶 changed.%r<br /><br /> 這被允許的因為這個外部系統的配接器已設定為允許對應 conflicts.%r<br /><br /> 追蹤識別碼: %1 %r<br /><br /> 配接器: %2 %r<br /><br /> Windows 帳戶: %3 %r<br /><br /> 外部帳戶 1: %4 %r<br /><br /> 外部帳戶 2: %5|  
  
## <a name="explanation"></a>說明  
 這是資訊訊息，指出外部密碼變更將造成不同的外部帳戶變更。  
