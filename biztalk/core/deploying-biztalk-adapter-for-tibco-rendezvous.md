...
在您使用之前[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]匯入繫結檔案，確認有用於回應的資料夾存在，及它們完全相同的新的電腦上，或者您也必須編輯繫結檔案。  
...
[使用 協調流程中的 BizTalk Server 例外狀況處理](../core/using-biztalk-server-exception-handling4.md)  
