...
## <a name="what-this-sample-does"></a>此範例的用途  
 此範例包括存取 Windows Management Instrumentation (WMI) 物件模型中，Visual Basic Scripting Edition (VBScript) 版本以及存取 Visual C# 版**System.Management**所提供的物件.NET Framework。 這兩個版本最後都會存取 BizTalk Server WMI 提供者來執行下列作業：  
...
- VBScript 版本： \<*範例路徑*\>\Admin\WMI\Enlist Orchestration\VBScript\  
