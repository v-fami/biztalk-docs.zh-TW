...
如果查閱協議的程序判斷協議，內送或外寄交換會解析[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]使用協議屬性 （不是管線屬性） 來判斷如何執行驗證。 如果沒有協議解析為某個交換，[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]使用某些後援協議屬性和某些管線屬性來執行驗證。  
 ...
 下表指出如何[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]判斷 EDI 交換上執行驗證。 如果無法判斷協議，則會使用針對管線和後援協議中的資料行的資料表，「 是 」 表示該組態。  
...
> [!NOTE]
>  即使您的設定是可透過管線，Microsoft 建議未在管線中設定屬性。  
  
## <a name="agreement-for-outbound-interchangesbiztalk-receive-pipeline"></a>針對輸出交換/BizTalk 接收管線的協議  
...
|驗證|設定協議|設定管線<sup>*</sup>|設定後援協議設定|  
|----------------|-----------------------------|----------------------------------------|-----------------------------------------------|  
|驗證/安全性|是|在協議層級才可用|在協議層級才可用|  
|傳送者識別碼|是|在協議層級才可用|在協議層級才可用|  
|RepSeparator /<br />ISA11|是|是|否|  
|ISA 重複/有效性|是|否|是|  
|GS 重複/有效性|是|否|是|  
|ST 重複/有效性|是|否|是|  
|群組層級 NS/TS|是|否|是|  
|版本/版次|是|在協議層級才可用|在協議層級才可用|  
  
 **EDIFACT 信封屬性的驗證**  
  
|驗證|設定協議|設定管線<sup>*</sup>|設定後援協議設定|  
|----------------|-----------------------------|----------------------------------------|-----------------------------------------------|  
|密碼|是|在協議層級才可用|在協議層級才可用|  
|SenderID|是|在協議層級才可用|在協議層級才可用|  
|群組層級 NS/TS|是|否|是|  
|版本/版次|是|在協議層級才可用|在協議層級才可用|  
|UNB 重複/有效性|是|否|是|  
|UNG 重複/有效性|是|否|是|  
...
|驗證|設定協議|設定管線<sup>*</sup>|設定後援協議設定|  
|----------------|-----------------------------|----------------------------------------|-----------------------------------------------|  
|發行準則|是|在協議層級才可用|在協議層級才可用|  
|範圍|是|在協議層級才可用|在協議層級才可用|  
|篩選|是|在協議層級才可用|在協議層級才可用|  
