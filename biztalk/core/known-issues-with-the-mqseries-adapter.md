...
> [!NOTE]
>  此錯誤訊息中*servername*是伺服器的名稱和*queuename*是佇列的名稱。  
 ...
 **方法 1： 啟用網路 COM + 存取 microsoft[!INCLUDE[btsWinSvr2k3](../includes/btswinsvr2k3-md.md)]或[!INCLUDE[btsWinSvr2k8](../includes/btswinsvr2k8-md.md)]為基礎的電腦**  
  
 Microsoft 上啟用網路 COM + 存取[!INCLUDE[btsWinSvr2k3](../includes/btswinsvr2k3-md.md)]或[!INCLUDE[btsWinSvr2k8](../includes/btswinsvr2k8-md.md)]-依電腦所述的步驟[如何啟用網路 COM + 存取在 Windows Server 2003](http://go.microsoft.com/fwlink/?LinkId=67076)。  
  
 **方法 2： 設定 MSDTC 設定**  
  
 請依照**上設定適當的 MSDTC 安全性組態選項[!INCLUDE[btsWinSvr2k8](../includes/btswinsvr2k8-md.md)]** 區段[疑難排解 MSDTC 問題的](../core/troubleshooting-problems-with-msdtc.md)設定 MSDTC 設定。  
 ...
 **方法 4： 確認 MQSeries 配接器的主控件帳戶是分散式 COM 使用者群組的成員**  
 ...
 在 Windows[!INCLUDE[btsWinSvr2k3](../includes/btswinsvr2k3-md.md)]或[!INCLUDE[btsWinSvr2k8](../includes/btswinsvr2k8-md.md)]-型伺服器，檢查 MQSeries 配接器的主控件帳戶的群組成員資格。 請確定帳戶的成員**Distributed COM Users** MQSAgent COM + 應用程式安裝所在的 MQSeries 伺服器上的群組。  
