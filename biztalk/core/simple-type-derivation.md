...
XML 結構描述定義 (XSD) 語言提供數種機制，用於定義，如下所示為基礎的現有的簡單型別衍生簡單類型的變化：  
...
-   [使用限制機制的簡單型別衍生](../core/simple-type-derivation-using-the-restriction-mechanism.md)  
  
-   [使用清單機制的簡單型別衍生](../core/simple-type-derivation-using-the-list-mechanism.md)  
  
-   [使用聯集機制的簡單型別衍生](../core/simple-type-derivation-using-the-union-mechanism.md)