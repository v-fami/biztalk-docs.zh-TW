...
-   **接收器記錄提供者**:\<追蹤項目 > 參數是**-接收者**。 使用**-接收者**可從接收配接器在執行階段的記錄檔取得任何訊息。  
  
-   **傳輸器記錄提供者**:\<追蹤項目 > 參數是**-傳輸器**。 使用**-傳輸器**可傳輸的配接器在執行階段的記錄檔中取得任何訊息。  
  
-   **管理記錄提供者**:\<追蹤項目 > 參數是**-管理**使用**-管理**可瀏覽期間所產生的記錄檔中取得任何訊息伺服器系統。  
