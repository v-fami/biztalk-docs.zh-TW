 ...
 **目標：** 在此步驟中，您必須新增第二個專案到 EAI 方案。 然後新增協調流程至新專案。  
  
 **用途：** 建立個別的協調流程專案。 當有幾個不同的人在處理方案時，這是有所助益的。 您使用新協調流程自動化本課程的商務程序。  
...
## <a name="procedures"></a>程序  
 如果您已關閉[!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)]視窗中，遵循 「 若要開啟 Visual Studio 專案 」 的程序[步驟 2： 建立庫存要求結構描述](../core/step-2-create-the-inventory-request-schema.md)加以開啟。  
  
#### <a name="to-add-another-project-to-your-solution"></a>新增另一個專案到您的方案  
  
1.  從 Visual Studio 中，在**檔案**功能表上，指向**新增**，然後按一下**新專案**。  
...
## <a name="next-steps"></a>後續步驟  
 定義中的商務程序[步驟 2： 定義商務程序](../core/step-2-define-the-business-process.md)。  
