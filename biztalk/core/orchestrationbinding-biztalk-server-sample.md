...
- 此範例需要 HelloWorld 範例由執行中的 setup.bat \<*範例路徑*\>\Orchestrations\HelloWorld 目錄。  
...
|                                     檔案                                     |                                                 描述                                                  |
|---------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
|                             OrchestrationBinding.cs                             | [!INCLUDE[btsVCSharp](../includes/btsvcsharp-md.md)] 此範例中示範的作業的原始程式檔。 |
...
1. 請確定您已完成建置和初始化 HelloWorld 範例的步驟。 會提供這些步驟[HelloWorld （BizTalk Server 範例）](../core/helloworld-biztalk-server-sample.md)。  
