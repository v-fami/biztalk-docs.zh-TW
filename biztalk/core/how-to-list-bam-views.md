...
ms.locfileid: "22254302"
---
# <a name="how-to-list-bam-views"></a>如何列出 BAM 檢視
系統管理員使用**get 檢視**命令，列出命令執行所在的電腦上的 BAM 主要匯入資料庫中所部署的 BAM 檢視。  
  
### <a name="to-list-bam-views"></a>列出 BAM 檢視  
