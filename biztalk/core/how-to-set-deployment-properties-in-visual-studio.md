...
2. 請檢查**部署**需要從開啟的方案部署的每個專案的選項。  
  
### <a name="to-configure-project-properties"></a>若要設定專案屬性  
  
1. 在 [[!INCLUDE[btsVStudioNoVersion](../includes/btsvstudionoversion-md.md)]方案總管] 中以滑鼠右鍵按一下的專案，您要設定屬性，然後按一下**屬性**。  
...
4. 針對方案中的每個專案，重複步驟 1、2 和 3。  
   ...
   |[伺服器]|\<伺服器名稱\>|在本機電腦上，裝載 BizTalk 管理資料庫之 SQL Server 執行個體的名稱。 在單一電腦安裝中，這通常是本機電腦的名稱。 **注意：** 如果您將這個 BizTalk 專案移到不同的電腦時，您可能需要修改以反映新的電腦名稱，您將能夠部署組件之前 [伺服器] 屬性。|  
