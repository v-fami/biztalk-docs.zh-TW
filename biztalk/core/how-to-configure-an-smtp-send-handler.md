...
4.  在**SMTP 傳輸屬性**對話方塊**屬性**索引標籤上，執行下列動作：  
    ...
    |**（電子郵件地址）**|必要。 輸入電子郵件地址，以將放在 SMTP**從**標頭。<br /><br /> 最大長度：256|  
    |**驗證類型**|輸入要使用的 SMTP 伺服器的驗證類型。<br /><br /> 選項：<br /><br /> -   **無驗證**<br />-   **基本驗證**<br />-   **處理序帳戶 (NTLM)**<br /><br /> 預設值：處理帳戶 (NTLM)|  
