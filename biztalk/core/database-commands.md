 ...
 **bm.exe 移轉 sql-從： sql2000-以： sql2008 [-NSUser:\<通知服務使用者名稱\>] [-NSUserPassword:\<通知服務使用者密碼\>] [-Server:\<伺服器\> ][-Database:\<資料庫\>]**  
  
 \- 或 -  
  
 **bm.exe 移轉 sql-從： sql2005-以： sql2008 [-NSUser:\<通知服務使用者名稱\>] [-NSUserPassword:\<通知服務使用者密碼\>] [-Server:\<伺服器\> ][-Database:\<資料庫\>]**  
