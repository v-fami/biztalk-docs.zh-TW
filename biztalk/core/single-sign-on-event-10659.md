...
ms.locfileid: "22271718"
---
# <a name="single-sign-on-event-10659"></a>單一登入： 事件 10659
...
|事件來源|ENTSSO|  
|元件|N\A|  
|符號名稱|SSO_INFO_PASSWORD_SYNC_WINDOWS_STARTING|  
|訊息文字|Windows （來自 PCNS) 的密碼同步是 starting.%r|  
  
## <a name="explanation"></a>說明  
 這個資訊事件表示正在啟動 Windows 的密碼同步處理。  
