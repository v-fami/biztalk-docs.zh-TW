...
## <a name="changing-timeouts-for-the-sso-system"></a><span data-ttu-id="73a42-104">變更 SSO 系統的逾時</span><span class="sxs-lookup"><span data-stu-id="73a42-104">Changing timeouts for the SSO System</span></span>  
 <span data-ttu-id="73a42-105">您可以修改「企業單一登入」(SSO) 系統層級上的兩個逾時：</span><span class="sxs-lookup"><span data-stu-id="73a42-105">You can modify two timeouts at the Enterprise Single Sign-On (SSO) system level:</span></span>  
  
 <span data-ttu-id="73a42-106">**票證逾時。**</span><span class="sxs-lookup"><span data-stu-id="73a42-106">**Ticket timeout.**</span></span> <span data-ttu-id="73a42-107">。此屬性指定 SSO 核發之票證的有效時間長度。</span><span class="sxs-lookup"><span data-stu-id="73a42-107">This property specifies the length of time for which a ticket SSO issues is valid.</span></span> <span data-ttu-id="73a42-108">為了滿足使用 SSO 的企業中大部分實例，預設的票證逾時為 2 分鐘。</span><span class="sxs-lookup"><span data-stu-id="73a42-108">To satisfy most of the scenarios in an enterprise that use SSO, the default ticket timeout is 2 minutes.</span></span> <span data-ttu-id="73a42-109">SSO 系統管理員可以根據應用程式需求變更此值。</span><span class="sxs-lookup"><span data-stu-id="73a42-109">The SSO administrator can change this based on the application requirements.</span></span>  
  
 <span data-ttu-id="73a42-110">**認證快取逾時。**</span><span class="sxs-lookup"><span data-stu-id="73a42-110">**Credential Cache timeout.**</span></span> <span data-ttu-id="73a42-111">。此屬性指定所有 SSO 伺服器的認證快取逾時。</span><span class="sxs-lookup"><span data-stu-id="73a42-111">This property specifies the credential cache timeout for all SSO Servers.</span></span> <span data-ttu-id="73a42-112">SSO 伺服器在第一次尋查之後會快取認證。</span><span class="sxs-lookup"><span data-stu-id="73a42-112">SSO Servers cache the credentials after the first lookup.</span></span> <span data-ttu-id="73a42-113">依照預設，認證快取逾時為 60 分鐘。</span><span class="sxs-lookup"><span data-stu-id="73a42-113">By default, the credential cache timeout is 60 minutes.</span></span> <span data-ttu-id="73a42-114">SSO 系統管理員可以根據安全性需求，將此變更為適當的值。</span><span class="sxs-lookup"><span data-stu-id="73a42-114">The SSO administrator can change this to a suitable value based on the security requirements.</span></span>  
  
 <span data-ttu-id="73a42-115">更新 SSO 資料庫即可變更這兩種逾時。</span><span class="sxs-lookup"><span data-stu-id="73a42-115">You change both of these timeouts by updating the SSO database.</span></span>  
  
 <span data-ttu-id="73a42-116">更新 SSO 資料庫的範例 XML 檔案為：</span><span class="sxs-lookup"><span data-stu-id="73a42-116">A sample XML file for updating the SSO database is:</span></span>  
...
3.  <span data-ttu-id="73a42-120">使用滑鼠右鍵按一下 **[系統]**，然後按一下 **[屬性]**。</span><span class="sxs-lookup"><span data-stu-id="73a42-120">Right-click **System**, and then click **Properties**.</span></span>  
  
4.  <span data-ttu-id="73a42-121">在 [SSO 系統屬性]  對話方塊中，按一下 [一般]  索引標籤。</span><span class="sxs-lookup"><span data-stu-id="73a42-121">On the **System Properties** dialog box, click the **General** tab.</span></span>  
  
5.  <span data-ttu-id="73a42-122">輸入適當的設定，然後按一下 **[確定]**。</span><span class="sxs-lookup"><span data-stu-id="73a42-122">Enter the appropriate settings, and click **OK**.</span></span>  
...
3.  <span data-ttu-id="73a42-126">在 [系統] 上按一下滑鼠右鍵，然後按一下 [升級資料庫] 。</span><span class="sxs-lookup"><span data-stu-id="73a42-126">Right-click **System**, and then click **Upgrade Database**.</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="73a42-133">請參閱</span><span class="sxs-lookup"><span data-stu-id="73a42-133">See Also</span></span>  
 <span data-ttu-id="73a42-134">[如何設定 SSO 票證](../core/how-to-configure-the-sso-tickets.md) </span><span class="sxs-lookup"><span data-stu-id="73a42-134">[How to Configure the SSO Tickets](../core/how-to-configure-the-sso-tickets.md) </span></span>  
 [<span data-ttu-id="73a42-135">使用 SSO</span><span class="sxs-lookup"><span data-stu-id="73a42-135">Using SSO</span></span>](../core/using-sso.md)