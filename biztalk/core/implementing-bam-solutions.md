...
---
# <a name="implementing-bam-solutions"></a>實作 BAM 解決方案
本節說明實作 BAM 解決方案的方法，包括擷取感興趣的資料、傳送資料至 BAM，以及基於變更商務需要而修改傳送至 BAM 的資料。  
...
-   [如何建立自訂的分析工作](../core/how-to-create-a-custom-analysis-task.md)  
...
-   [使用 BAM Api 的考量事項](../core/considerations-for-working-with-bam-apis.md)  
  
-   [如何修飾 BAM 資料使用查閱](../core/how-to-enrich-bam-data-using-lookups.md)  
