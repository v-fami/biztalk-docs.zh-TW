...
## <a name="working-with-the-orchestration-schedule-view"></a>使用協調流程排程檢視  
 選取協調流程檢視，請按一下**選取事件來源**按鈕，然後按一下**選取協調流程排程**功能表項目。 接著選取組件，然後選取其中的協調流程。 一旦選取協調流程，您就可以將代表協調流程建構或動作的協調流程圖形從協調流程拖曳到活動檢視的商務里程碑資料夾中，以執行下列動作：  
...
-   指定關聯的基礎建構或動作完成時要追蹤的時間戳記。  
 ...
 如需協調流程檢視 」 中顯示的說明，請參閱[協調流程圖形](../core/orchestration-shapes.md)。  
  
 可用協調流程的清單可能相當冗長。 如果您知道您要搜尋的協調流程的名稱的一部分，您可以輸入在**中字串**文字方塊中，然後按一下**搜尋** 按鈕。 如此，將只會搜尋含有您輸入之部分字串的協調流程。  
