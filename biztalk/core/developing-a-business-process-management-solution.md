...
---
# <a name="developing-a-business-process-management-solution"></a>開發商務程序管理解決方案
本節描述與設計解決方案相關的基本模式，以及這些模式如何轉譯為 BizTalk 元件與結構。 本節也會在解決方案中逐步處理訂單訊息、提供其他實作詳細資料、讓您瞭解如何規劃解決方案，並提供訊息與檔案參考。 如需解決方案與其設計背後的商務需求的詳細資訊，請參閱 < 商務需求 > 中[了解商務程序管理解決方案](../core/understanding-the-business-process-management-solution.md)。  
