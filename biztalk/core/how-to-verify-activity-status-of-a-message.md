...
1.  按一下**啟動**，指向**程式**，指向  **PeopleSoft 應用程式名稱**，然後選取**應用程式設計工具**。  
  
2.  上**PeopleSoft sign-on**畫面上，輸入**使用者識別碼**和**密碼**，然後按一下 **確定**。  
...
3.  在 應用程式設計工具中上,**檔案**功能表上，指向**開啟**，然後選取**訊息**。  
...
5.  在**定義符合選取準則**區段中，按兩下**LOCATION_SYNC**檢視內容的訊息。  
