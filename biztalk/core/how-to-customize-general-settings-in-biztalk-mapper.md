...
您可以變更對應中的特定檢視選項的預設設定。 每當您開啟 Visual Studio 時，都可以使用這些設定。 本主題提供這些選項的資訊。  
 ...
 您也可以設定預設的色彩與字型設定。 如需如何選擇的設定資訊，請參閱[如何自訂色彩和字型，在 BizTalk 對應工具](../core/how-to-customize-colors-and-font-in-biztalk-mapper.md)。  
...
2. 在 **選項**對話方塊中，在左窗格中，展開**BizTalk 對應工具**節點，然後再按一下**一般**。  
...
4. 按一下 [確定] 。 就會將設定儲存為預設值。  
   ...
   > [!IMPORTANT]
   >  如果不想使用自訂的設定，請按一下**還原成預設值**中**選項** 對話方塊。  
