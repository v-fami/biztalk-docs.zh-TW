...
使用舊版的 BizTalk 對應工具時，如果對應包含大型的結構描述，您必須手動捲動來源結構描述窗格、格線頁和目標結構描述窗格，才能在單一檢視中包含所有相關的對應項目。 含有 [!INCLUDE[prague](../includes/prague-md.md)] 的 BizTalk 對應工具可自動捲動格線頁，讓您將所選運算質/連結的所有相關對應項目放到單一檢視中。 本主題提供如何執行此作業的相關資訊。  
