...
-   <span data-ttu-id="56e0e-107">選取的節點有中置分隔的父系。</span><span class="sxs-lookup"><span data-stu-id="56e0e-107">The selected node has a parent that is infix delimited.</span></span>  
  
-   <span data-ttu-id="56e0e-108">選取的節點有指定的開始位置。</span><span class="sxs-lookup"><span data-stu-id="56e0e-108">The selected node has a specified starting position.</span></span>  
  
 <span data-ttu-id="56e0e-109">請注意，巢狀序數記錄和父系為分隔的容器 (分隔符號為空值) 之序數記錄有所不同。</span><span class="sxs-lookup"><span data-stu-id="56e0e-109">Note that there is a distinction between nested positional records and positional records whose parent is a delimited container where the delimiter is null.</span></span> <span data-ttu-id="56e0e-110">對於真正巢狀位置的結構而言，在決定深度時不能有任何模稜兩可之處。</span><span class="sxs-lookup"><span data-stu-id="56e0e-110">For structures to be truly nested positionally, there must not be any ambiguity in determining their length.</span></span> <span data-ttu-id="56e0e-111">例如，分隔的迴圈節點可以包含一個重複的序數記錄，出現 0 至 N 次。</span><span class="sxs-lookup"><span data-stu-id="56e0e-111">For example, a delimited loop node can contain a repeating positional record that occurs 0 to N times.</span></span> <span data-ttu-id="56e0e-112">不過，因為該迴圈節點本身由位置決定，而且也可能包含對等於重複序數記錄的欄位，所以必須確定重複序數記錄的出現次數 (正整數)。</span><span class="sxs-lookup"><span data-stu-id="56e0e-112">However, for that loop node itself to be positional, and possibly also contain fields as peers to the repeating positional record, the occurrence of the repeating positional record must be deterministic (a positive integer).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="56e0e-113">另請參閱</span><span class="sxs-lookup"><span data-stu-id="56e0e-113">See Also</span></span>  
 [<span data-ttu-id="56e0e-114">位置記錄的考量</span><span class="sxs-lookup"><span data-stu-id="56e0e-114">Positional Record Considerations</span></span>](../core/positional-record-considerations.md)