---
title: EDIFACT CONTRL 訊息作為技術通知 |Microsoft Docs
ms.custom: ''
ms.date: 06/08/2017
...
ms.locfileid: "37014447"
---
# <a name="edifact-contrl-message-as-technical-acknowledgment"></a>EDIFACT CONTRL 訊息為技術通知
如果您選取要產生技術通知，在商務設定檔設定或交易夥伴協議 （或後援協議，如果未定義協議是兩個商務設定檔之間），或如果設定為"2"，CONTRL 訊息中的 UNB9 欄位做為技術通知，將會產生訊息。 這個通知 (ACK) 會報告接收交換時的結果。  
...
|UCI4|動作代碼|這些動作代碼包括：<br /><br /> -8 如果交換已接受<br /><br /> -7，當交換已接受，但某些交易集合遭到拒絕<br /><br /> -4，當交換因 UNA 或 UNB 區段錯誤而拒絕<br /><br /> 這是必要的資料元素。|  
...
|UCI7|資料元素識別碼|識別具有 UCI5 資料元素中已指出之錯誤狀況的資料元素。 UCI7 的子元件包括：<br /><br /> -錯誤資料元素區段中的位置 （必要項）<br /><br /> -錯誤元件資料元素區段中的位置 （條件式選用性）<br /><br /> -出現的區段 （條件式選用性） 中的錯誤資料元素|  
|UCI8|-|-|  
|UNT1|區段計數|-|  
|UNT2|訊息參考編號|-|