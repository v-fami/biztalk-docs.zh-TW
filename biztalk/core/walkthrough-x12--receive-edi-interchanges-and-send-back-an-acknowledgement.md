...
8. 在主控台樹狀目錄中，選取**篩選器**。 輸入訂閱 EDI 交換的篩選條件。 例如，對於**屬性**，輸入**BTS。MessageType**; 對於**運算子**，輸入**==**; 以及**值**的交換中，輸入結構描述，例如 http://schemas.microsoft.com/BizTalk/Edi/X12/2006#X12_00401_850 .  
...
8. 在主控台樹狀目錄中，選取**篩選器**。 輸入訂閱 TA1 通知的篩選條件。 例如，對於**屬性**，輸入**BTS。MessageType**; 對於**運算子**，輸入**==**; 及針對**值**比方說，在通知中，輸入的結構描述 http://schemas.microsoft.com/Edi/X12#X12_TA1_Root .  
