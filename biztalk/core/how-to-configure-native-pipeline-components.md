...
---
# <a name="how-to-configure-native-pipeline-components"></a><span data-ttu-id="85dd5-102">如何設定原生管線元件</span><span class="sxs-lookup"><span data-stu-id="85dd5-102">How to Configure Native Pipeline Components</span></span>
<span data-ttu-id="85dd5-103">下列程式碼示範如何使用 `IPersistPropertyBag` 介面來設定原生管線元件。</span><span class="sxs-lookup"><span data-stu-id="85dd5-103">The following code shows how to configure native pipeline components using the `IPersistPropertyBag` interface.</span></span>  
