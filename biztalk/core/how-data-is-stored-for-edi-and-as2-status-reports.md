...
ms.locfileid: "22246422"
---
# <a name="how-data-is-stored-for-edi-and-as2-status-reports"></a>如何儲存 EDI 和 AS2 狀態報告的資料
本節描述 BizTalk [!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)] 如何儲存 EDI 和 AS2 狀態報告的資料。  
