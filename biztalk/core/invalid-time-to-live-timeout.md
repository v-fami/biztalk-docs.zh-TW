...
|元件|0|  
|符號名稱|0|  
|訊息文字|即時逾時的時間無效。 有效範圍： 0 到 23 小時，0 到 59 分鐘的時間，以及 0 到 59 秒|  
...
6.  在 連接埠**類型**清單中，選取**Wcf-netmsmq**。  
  
7.  按一下**設定**。  
  
8.  在**Wcf-netmsmq 傳輸屬性**對話方塊中，按一下 [**繫結**] 索引標籤。  
  
9. 在**佇列設定**區段中，確定**訊息即時 (dd:hh:mm:ss) 的時間**範圍是否有效。 可接受的值為 0 到 23 小時，0 到 59 分鐘的時間，以及 0 到 59 秒數。