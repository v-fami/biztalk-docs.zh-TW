...
---
# <a name="what-is-a-scheduled-aggregation"></a>什麼是排程彙總？
排程彙總代表特定時間的商務快照集；例如，今日上午出貨的摘要。 請向資料庫管理員詢問您的彙總是在何時處理的，然後您就可以查閱歷史資料。  
  
## <a name="see-also"></a>另請參閱  
 [什麼是即時彙總？](../core/what-is-a-real-time-aggregation.md)   
