...
---
# <a name="single-sign-on-event-10667"></a>單一登入： 事件 10667
...
|事件來源|ENTSSO|  
|元件|N\A|  
|符號名稱|SSO_INFO_SUPPRESSED_DUPLICATE_WINDOWS_PASSWORD_CHANGE|  
|訊息文字|隱藏重複的 Windows 密碼變更。%r<br /><br /> 追蹤識別碼: %1 %r<br /><br /> 配接器: %2 %r<br /><br /> Windows 帳戶： %3|  
  
## <a name="explanation"></a>說明  
 這個資訊事件表示 SSO 已抑制重複 Windows 密碼變更。  
