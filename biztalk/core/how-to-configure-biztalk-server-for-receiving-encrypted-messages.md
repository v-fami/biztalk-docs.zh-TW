...
## <a name="prerequisites"></a>必要條件  
 在設定之前先[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]來接收加密的訊息，您必須執行中的步驟[如何安裝加密訊息的憑證](../core/how-to-install-the-certificates-for-encrypted-messages.md)。  
...
3.  設定主應用程式做為接收處理常式，如您在程序中安裝解密憑證的接收位置 若要設定來接收加密的訊息的 BizTalk 主控件 」 中[如何安裝憑證，加密訊息](../core/how-to-install-the-certificates-for-encrypted-messages.md)。 如需如何設定主機內容，請參閱[如何修改主機內容](../core/how-to-modify-host-properties.md)。  
