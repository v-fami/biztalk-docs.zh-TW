...
-   [MQSeries 配接器的命令列組態精靈](../core/command-line-configuration-wizard-for-the-mqseries-adapter.md)  
  
-   [MQSeries 配接器的 XML 組態檔](../core/xml-configuration-file-for-the-mqseries-adapter.md)