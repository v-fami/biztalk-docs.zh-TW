...
3.  <span data-ttu-id="e6318-108">型別**ssoconfig – setSSL\<是/否\>**，其中\<**是/否**\>指出您是否要啟用 SSO 系統中的 SSL。</span><span class="sxs-lookup"><span data-stu-id="e6318-108">Type **ssoconfig –setSSL \<yes/no\>**, where \<**yes/no**\> indicates whether you want to enable SSL in the SSO system.</span></span>  
  
    > [!NOTE]
    >  <span data-ttu-id="e6318-109">在支援使用者帳戶控制 (UAC) 的系統上，您可能需要使用系統管理權限來執行工具。</span><span class="sxs-lookup"><span data-stu-id="e6318-109">On a system that supports User Account Control (UAC), you may need to run the tool with Administrative privileges.</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="e6318-110">請參閱</span><span class="sxs-lookup"><span data-stu-id="e6318-110">See Also</span></span>  
 [<span data-ttu-id="e6318-111">使用 SSO</span><span class="sxs-lookup"><span data-stu-id="e6318-111">Using SSO</span></span>](../core/using-sso.md)