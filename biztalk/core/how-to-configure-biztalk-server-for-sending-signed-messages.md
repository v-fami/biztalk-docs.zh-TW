...
## <a name="prerequisites"></a>必要條件  
 在設定之前先[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]來傳送簽署的訊息，您必須執行中的步驟[如何安裝數位簽章憑證](../core/how-to-install-the-certificates-for-digital-signatures.md)。  
...
3. 在 屬性 視窗中，設定 MIME/SMIME 編碼器管線元件**簽章類型**屬性設**ClearSign**或是**blobsign**。 如需詳細資訊**啟用加密**屬性，請參閱[如何設定 MIME SMIME 編碼器管線元件](../core/how-to-configure-the-mime-smime-encoder-pipeline-component.md)。  
...
3.  設定 BizTalk 群組的簽章的憑證，您在安裝[如何安裝數位簽章憑證](../core/how-to-install-the-certificates-for-digital-signatures.md)。 如需如何設定 BizTalk 群組，請參閱[如何修改群組內容](../core/how-to-modify-group-properties.md)。  
