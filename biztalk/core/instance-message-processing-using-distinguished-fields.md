...
使用 升級屬性 **辨別欄位** 機制不需要建立屬性結構描述。 當您使用所有的屬性升級 **升級屬性** 對話方塊中，以存取使用 **升級屬性** 屬性 **結構描述** 節點在訊息結構描述，或使用 **升階 &#124; 顯示升級** 命令 **BizTalk** 或快顯功能表。  
  
 在 **升級屬性** 對話方塊方塊中，確認 **辨別欄位** 在對話方塊的右邊選取索引標籤。 然後展開的節點在結構描述樹狀目錄中，尋找並選取對話方塊左側 **欄位項目** 節點或 **欄位屬性** 節點，您想要升級為辨別欄位，然後按一下  **新增**。 如需升級屬性的逐步指示**辨別欄位**使用**升級屬性** 對話方塊中，請參閱[複製資料至訊息內容做 Distinguished欄位](../core/how-to-copy-data-to-the-message-context-as-distinguished-fields.md)。  
