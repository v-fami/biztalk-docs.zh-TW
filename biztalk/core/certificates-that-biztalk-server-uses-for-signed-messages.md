...
6. 適當的 BizTalk Server 傳送處理常式將訊息傳送給夥伴。  
  
7. 在傳送管線執行期間，MIME/SMIME 編碼器管線元件會使用 BizTalk Server 私密金鑰來簽署訊息。  
  
8. 夥伴從 BizTalk Server 接收訊息。 夥伴使用 BizTalk Server 公開金鑰來驗證數位簽章。  
