...
## <a name="in-this-section"></a><span data-ttu-id="3b9b2-105">本節內容</span><span class="sxs-lookup"><span data-stu-id="3b9b2-105">In This Section</span></span>  
  
-   [<span data-ttu-id="3b9b2-106">何謂 Wcf-nettcp 配接器？</span><span class="sxs-lookup"><span data-stu-id="3b9b2-106">What Is the WCF-NetTcp Adapter?</span></span>](../core/what-is-the-wcf-nettcp-adapter.md)  
  
-   [<span data-ttu-id="3b9b2-107">設定 Wcf-nettcp 配接器</span><span class="sxs-lookup"><span data-stu-id="3b9b2-107">Configuring the WCF-NetTcp Adapter</span></span>](../core/configuring-the-wcf-nettcp-adapter.md)