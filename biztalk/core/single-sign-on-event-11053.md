...
|訊息文字|應用程式系統管理員帳戶包含一或多個個別 （非群組） 帳戶。 如果從 Active Directory 或本機電腦中刪除這些個別帳戶立即將它們必須移除從 SSO 系統，或可能會成為安全性的 risk.%r<br /><br /> 應用程式名稱: %1 %r<br /><br /> 應用程式系統管理員: %2 %r<br /><br /> 個別帳戶： %3|  
