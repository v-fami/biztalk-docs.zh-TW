...
-   [準備安裝服務導向解決方案配接器與內嵌版本的電腦](#step1)  
  
-   [移除服務導向解決方案的虛設常式版本](#step3)  
  
-   [準備後端系統，服務導向解決方案存取](#step5)  
  
-   [設定 Web 伺服器針對安全通訊端層 (SSL)](#step7)  
  
-   [建立後端系統的 Web 服務](#step9)  
  
-   [建立服務導向解決方案的 TI 元件](#step11)  
  
-   [建立協調流程的虛擬目錄的 Web 服務](#step13)  
  
-   [建置服務導向解決方案](#step15)  
  
-   [建立 SSO 分支機構應用程式](#step17)  
  
-   [部署服務導向解決方案的 BAM 定義檔案](#step19)  
  
-   [部署服務導向解決方案](#step21)  
  
-   [設定大型主機無法使用時的虛設常式擱置交易 Web 服務](#step23)  
...
#### <a name="to-prepare-the-computer-for-installing-the-adapter-and-inline-versions-of-the-service-oriented-solution"></a>準備安裝服務導向解決方案配接器與內嵌版本的電腦  
...
#### <a name="to-remove-the-stub-version-of-the-service-oriented-solution"></a>移除服務導向解決方案的虛設常式版本  
...
#### <a name="to-install-the-required-applications-for-the-back-end-systems-for-the-service-oriented-solution-to-access"></a>安裝後端系統所需的應用程式以供服務導向解決方案存取  
  
1.  在本機電腦上安裝 IBM WebSphere MQ for Windows Version 5.3 Server。  
...
#### <a name="to-create-the-mqseries-queues"></a>建立 MQSeries 佇列  
...
#### <a name="to-complete-configuration-of-the-mqseries-adapter"></a>完成 MQSeries 配接器組態  
...
#### <a name="to-configure-the-mainframe-cics-application"></a>設定大型主機 CICS 應用程式  
...
1.  使用「記事本」開啟 %BTSSolutionsPath%\SO\MFAccess\HISTIComponent 資料夾中的 bizcbl.txt 及其 "Copy Book" (MainFrameProgramVTCS2Description.txt)，然後檢視內容。  
    ...
    > [!NOTE]
    >  您也可以使用 Copy Book，利用 [!INCLUDE[vs2010](../includes/vs2010-md.md)] 搭配 TI 設計師外掛程式，來產生交易整合器 (TI) 中繼資料檔。  
...
#### <a name="to-install-certificate-services"></a>安裝憑證服務  
...
#### <a name="to-create-a-certificate-request"></a>建立憑證要求  
...
#### <a name="to-submit-the-certificate-request-to-the-certification-authority"></a>提交憑證要求給憑證授權單位  
...
#### <a name="to-issue-a-certificate-using-certification-authority-management-tool"></a>使用憑證授權單位管理工具發出憑證  
...
#### <a name="to-download-the-certificate-to-the-web-server"></a>將憑證下載至 Web 伺服器  
...
#### <a name="to-install-the-certificate-to-the-web-server"></a>將憑證安裝至 Web 伺服器  
...
#### <a name="to-create-a-new-iis-application-pool-for-the-pending-transaction-web-services"></a>為擱置交易 Web 服務建立新的 IIS 應用程式集區  
...
#### <a name="to-create-the-pendingtransactions-web-service-for-runtime"></a>為執行階段建立擱置交易 Web 服務  
...
#### <a name="to-create-the-pendingtransactions-web-service-for-development-environment"></a>為開發環境建立擱置交易 Web 服務  
...
#### <a name="to-create-the-stub-sap-web-service"></a>建立虛設常式 SAP Web 服務  
...
#### <a name="to-create-a-com-application-for-the-ti-component"></a>建立 TI 元件的 COM+ 應用程式  
...
#### <a name="to-create-a-remote-environment-to-access-the-mainframe"></a>建立遠端環境以存取大型主機  
...
#### <a name="to-create-the-ti-component-for-the-service-oriented-solution"></a>建立服務導向解決方案的 TI 元件  
...
#### <a name="to-test-the-connectivity-to-the-mainframe"></a>測試大型主機連線  
...
#### <a name="to-create-the-virtual-directories-for-the-orchestration-web-services"></a>為協調流程 Web 服務建立虛擬目錄  
...
#### <a name="to-create-the-sso-affiliate-applications"></a>建立 SSO 分支機構應用程式  
...
#### <a name="to-deploy-the-bam-definition-file-for-the-service-oriented-solution"></a>部署服務導向解決方案的 BAM 定義檔案  
...
#### <a name="to-edit-the-binding-files-for-the-service-oriented-solution"></a>編輯服務導向解決方案的繫結檔案  
...
#### <a name="to-configure-the-stub-pending-transactions-web-service-for-using-the-adapter-version-without-a-mainframe"></a>設定虛設常式擱置交易 Web 服務 (以便在大型主機無法使用時使用配接器版本)  
...
#### <a name="to-configure-the-stub-pending-transactions-web-service-for-using-the-inline-version-without-a-mainframe"></a>設定虛設常式擱置交易 Web 服務 (以便在大型主機無法使用時使用內嵌版本)  
...
#### <a name="to-start-the-service-oriented-solution"></a>啟動服務導向解決方案  
