...
## <a name="importing-the-biztalk-adapter-framework-extensions-schema-xsd"></a><span data-ttu-id="8cf4a-107">匯入 BizTalk 配接器架構延伸模組結構描述 XSD</span><span class="sxs-lookup"><span data-stu-id="8cf4a-107">Importing the BizTalk Adapter Framework Extensions Schema XSD</span></span>  
 <span data-ttu-id="8cf4a-108">藉由匯入配接器架構延伸模組結構描述 XSD，您可以使用裝飾例如\<baf:FileName\>做為項目的類型，其中顯示檔案名稱的快顯時編輯項目。</span><span class="sxs-lookup"><span data-stu-id="8cf4a-108">By importing the Adapter Framework extensions schema XSD, you can use decorations such as \<baf:FileName\> as an element's type, which shows the file name pop-up when editing the element.</span></span>  
  
 <span data-ttu-id="8cf4a-109">其他裝飾會控制屬性在介面中的顯示方式。</span><span class="sxs-lookup"><span data-stu-id="8cf4a-109">Additional decorations control the display of the property in the interface.</span></span> <span data-ttu-id="8cf4a-110">\<Baf: description\>裝飾，例如，加入說明文字的項目。</span><span class="sxs-lookup"><span data-stu-id="8cf4a-110">The \<baf:description\> decoration, for example, adds help text to the element.</span></span> <span data-ttu-id="8cf4a-111">\<Baf: description\>裝飾底部的屬性頁上顯示的文字。</span><span class="sxs-lookup"><span data-stu-id="8cf4a-111">The \<baf:description\> decoration displays the text at the bottom of the property page.</span></span> <span data-ttu-id="8cf4a-112">\<Browsable>： 可瀏覽\>裝飾會隱藏在介面中的項目。</span><span class="sxs-lookup"><span data-stu-id="8cf4a-112">The \<baf:browsable\> decoration hides an element from the interface.</span></span> <span data-ttu-id="8cf4a-113">下列程式碼顯示如何在組態結構描述中使用這些項目：</span><span class="sxs-lookup"><span data-stu-id="8cf4a-113">The following code shows how you can use these elements within a configuration schema:</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="8cf4a-114">請參閱</span><span class="sxs-lookup"><span data-stu-id="8cf4a-114">See Also</span></span>  
 [<span data-ttu-id="8cf4a-115">配接器架構設定結構描述延伸模組</span><span class="sxs-lookup"><span data-stu-id="8cf4a-115">Adapter Framework Configuration Schema Extensions</span></span>](../core/adapter-framework-configuration-schema-extensions.md)