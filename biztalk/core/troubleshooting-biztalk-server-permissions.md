...
---
# <a name="troubleshooting-biztalk-server-permissions"></a>BizTalk Server 權限疑難排解
BizTalk Server 中的權限問題通常會分為下列類別：  
  
-   SQL Server 權限  
  
-   BizTalk Server 多伺服器安裝上的 Active Directory 權限  
  
-   Web 服務權限  
  
-   IIS 權限  
  
 本主題包含一些一般指導方針，可用來避免權限問題，另外也包含用於特定案例的疑難排解步驟。  
