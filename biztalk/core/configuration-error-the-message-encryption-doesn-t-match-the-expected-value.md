...
1.  如果**覆寫輸入的訊息屬性 屬性選取**的合作對象當做 AS2 訊息傳送者在 BizTalk Server 管理主控台中，AS2 屬性 對話方塊頁面**訊息應該加密**選取屬性，但是訊息並未加密，請連絡傳送訊息的合作對象並要求他們將訊息加密，，重新傳送它。 您可以清除或**訊息應該加密**屬性，或**覆寫輸入的訊息屬性**屬性。  
