...
## <a name="in-this-section"></a><span data-ttu-id="0cdc7-105">本節內容</span><span class="sxs-lookup"><span data-stu-id="0cdc7-105">In This Section</span></span>  
  
-   [<span data-ttu-id="0cdc7-106">檢查清單： 部署 BizTalk 應用程式</span><span class="sxs-lookup"><span data-stu-id="0cdc7-106">Checklist: Deploy a BizTalk Application</span></span>](../core/checklist-deploy-a-biztalk-application.md)  
  
-   [<span data-ttu-id="0cdc7-107">檢查清單： 更新 BizTalk 應用程式中的成品</span><span class="sxs-lookup"><span data-stu-id="0cdc7-107">Checklist: Update the Artifacts in a BizTalk Application</span></span>](../core/checklist-update-the-artifacts-in-a-biztalk-application.md)  
  
-   [<span data-ttu-id="0cdc7-108">檢查清單： 解除部署 BizTalk 應用程式</span><span class="sxs-lookup"><span data-stu-id="0cdc7-108">Checklist: Undeploy a BizTalk Application</span></span>](../core/checklist-undeploy-a-biztalk-application.md)