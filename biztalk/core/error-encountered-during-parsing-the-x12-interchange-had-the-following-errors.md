...
---
# <a name="error-encountered-during-parsing-the-x12-interchange-had-the-following-errors"></a>在剖析期間發生錯誤。 X12 交換發生下列錯誤
...
|訊息文字|在剖析期間發生錯誤。 X12 交換傳送者識別碼 '{1}'，接收者識別碼 '{2}' 識別碼為 '{0}'，發生下列錯誤：|  
