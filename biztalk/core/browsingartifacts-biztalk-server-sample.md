...
BrowsingArtifacts 範例會示範如何列舉 BizTalk 成品和屬性。  
...
## <a name="what-this-sample-does"></a>此範例的用途  
 此範例示範如何使用**BtsCatalogExplorer**從類別**Microsoft.BizTalk.ExplorerOM**列舉成品，並報告其屬性的命名空間。 此範例所產生的報表中包含下列構件： 協調流程、 連接埠、 組件、 合作對象，以及轉換。 這個範例以 Microsoft [!INCLUDE[btsVCSharp](../includes/btsvcsharp-md.md)]。 本主題中，也會提供 Windows PowerShell 範例指令碼。  
...
|                                檔案                                 |                                                 描述                                                  |
|------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
|                          BrowsingArtifacts.cs                          | [!INCLUDE[btsVCSharp](../includes/btsvcsharp-md.md)] 此範例中示範的作業的原始程式檔。 |
...
## <a name="windows-powershell-script-example"></a>Windows PowerShell 指令碼範例  
 下列 Windows PowerShell 指令碼可以用來示範相同的功能**ExplorerOM**類別：  
...
```  
 ...
 執行 Windows PowerShell 指令碼，以及範例輸出的範例如下：  
