...
## <a name="explanation"></a>說明  
 這個警告事件表示 Windows 已要求密碼同步，但是未設定任何全域旗標。 有兩個旗標，可讓傳送密碼至外部系統的其中一個： SSO_FLAG_FULL_SYNC_FROM_WINDOWS_TO_EXTERNAL，另一個，可讓接收的外部系統 SSO_FLAG_PARTIAL_SYNC_FROM_EXTERNAL_TO_DB 的密碼。  
