...
- 請確認憑證藉由檢查憑證撤銷清單中未被撤銷。 (您可以藉由檢查的一般 AS2 屬性中的 檢查憑證撤銷清單屬性自動檢查此 BizTalk Server[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]管理主控台。)  
