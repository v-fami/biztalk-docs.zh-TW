...
ms.locfileid: "22270694"
---
# <a name="single-sign-on-event-10691"></a>單一登入： 事件 10691
...
|事件來源|ENTSSO|  
|元件|N\A|  
|符號名稱|SSO_ERROR_REPLAY_FILE_MISMATCH|  
|訊息文字|在重新執行檔案中偵測到損毀。%r<br /><br /> 重新執行檔案: %1 %r<br /><br /> 其他資料： %2|  
  
## <a name="explanation"></a>說明  
 這個錯誤事件表示 SSO 已重新建立連絡人與 SSO 資料庫中，但無法開啟重新執行檔案因為不相符，與對應的進度檔案。 如果 SSO 無法開啟重新執行檔案，它將繼續進行下一個重新執行檔案 （如果有的話）。  
