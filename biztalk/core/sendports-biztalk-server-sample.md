...
SendPorts 範例示範如何列舉使用和管理傳送埠**Microsoft.BizTalk.ExplorerOM**管理類別。  
...
## <a name="what-this-sample-does"></a>此範例的用途  
 此範例示範如何使用**BtsCatalogExplorer**並**SendPort**類別**Microsoft.BizTalk.ExplorerOM** 中的命名空間來管理傳送埠[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]環境。 此範例以 Microsoft [!INCLUDE[btsVCSharp](../includes/btsvcsharp-md.md)]。 本主題也包含 Windows PowerShell 範例指令碼。 此範例會示範下列作業：  
...
5. 設定新的傳送埠。 此範例所示範的設定會套用至名為 myStaticOnewaySendPort1 範例傳送埠。 下列範例所套用的設定：  
...
6. 變更兩個新的傳送埠上的傳送埠狀態。  執行此範例會對 myStaticOnewaySendPort1 下列的狀態變更：  

   -   將狀態變更為已啟動。  

   -   將狀態變更為已停止。  

   -   將狀態變更為繫結。 繫結的狀態相當於取消登錄。  
...
|                    檔案                     |                                                 描述                                                  |
|------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
|                  SendPorts.cs                  | [!INCLUDE[btsVCSharp](../includes/btsvcsharp-md.md)] 此範例中示範的作業的原始程式檔。 |
