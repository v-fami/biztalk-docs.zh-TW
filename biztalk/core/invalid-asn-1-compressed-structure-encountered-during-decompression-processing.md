...
ms.locfileid: "22257094"
---
# <a name="invalid-asn1-compressed-structure-encountered-during-decompression-processing"></a>解壓縮處理過程中發現無效的 ASN.1 壓縮結構
...
|元件|AS2 引擎|  
|符號名稱|InvalidASN1CompressedStructureEncountered|  
