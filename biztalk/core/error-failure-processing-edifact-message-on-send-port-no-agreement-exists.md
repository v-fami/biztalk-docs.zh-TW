...
---
# <a name="a-failure-occurred-in-processing-edifact-message-on-send-port-no-agreement-for-receiver-and-sender-identifier-qualifier-pairs-and-no-party-with-name"></a>處理傳送埠上的 Edifact 訊息時發生錯誤： 沒有名稱的合作對象的收件者及寄件者識別碼辨識符號配對不一致
...
|    元件    |                                                                                            將 EDI 引擎                                                                                            |
|  符號名稱  |                                                                                                -                                                                                                 |
|  訊息文字   | 處理傳送埠上的 Edifact 訊息時發生失敗{0}。 沒有協議的收件者及寄件者識別碼/辨識符號配對存在{1}， {2}， {3}， {4}。 沒有合作對象有名稱{5}。 |
