...
Microsoft BizTalk Adapter for JD Edwards OneWorld 要求您選取 XMLTransmit 和 XMLReceive 傳送和接收管線。  
  
1.  在**BizTalk Server 管理**，依序展開**應用程式**，然後展開您的應用程式。  
  
2.  選取**傳送埠**，以滑鼠右鍵按一下傳送埠，然後選取**屬性**。  
  
3.  在**傳送埠屬性**，執行下列動作：  
  
    1.  選取傳送管線從**傳送管線**下拉式清單。  
  
    2.  選取接收管線就會從**接收管線**下拉式清單。  
  
4.  選取 [確定]。  

## <a name="next-steps"></a>後續的步驟
[配接器結構描述匯入 Visual Studio](importing-jd-edwards-oneworld-schemas-into-biztalk-server-projects.md)  
