...
ms.locfileid: "22241678"
---
# <a name="a-failure-occurred-in-processing-edifact-message-on-send-port-no-agreement-for-receiver-and-sender-identifier-qualifier-pairs"></a>在處理傳送埠上的 Edifact 訊息發生失敗： 沒有協議接收者和傳送者識別碼辨識符號組
...
|元件|EDI 引擎|  
|符號名稱|-|  
|訊息文字|在處理傳送埠 {0} 上的 Edifact 訊息發生失敗。 {1}、 {2}、 {3}、 \ {4 的收件者和寄件者識別碼/辨識符號配對不存在任何協議。|  
