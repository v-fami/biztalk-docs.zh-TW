...
- 不用考慮完成訊息處理時，例如以新版本更新結構描述或對應，這是較一般的更新案例。  
  ...
  在一般更新案例中，您可以用新版本更新成品，例如處理商務需求的變更。 這個案例相當單純，您可以用更新版本來覆寫原始成品。 如需相關步驟，請參閱[檢查清單： 更新 BizTalk 應用程式中的成品](../core/checklist-update-the-artifacts-in-a-biztalk-application.md)。  
