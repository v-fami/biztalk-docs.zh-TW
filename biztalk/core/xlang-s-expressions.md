...
---
# <a name="xlang-s-expressions"></a>XLANG 的運算式
運算式是一串運算子和運算元。 本主題將描述 XLANG/s 支援各種運算式的語法。  
  
## <a name="basic-expressions"></a>基本運算式  
 下列程式碼示範基本運算式的語法：  
...
## <a name="service-and-method-arguments"></a>服務和方法引數  
 下列程式碼示範服務和方法引數的語法：  
...
## <a name="top-level-expressions"></a>最上層的運算式  
 下列程式碼示範最上層運算式的語法：  
