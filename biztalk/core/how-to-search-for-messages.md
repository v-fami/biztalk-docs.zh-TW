...
您可以使用 **查詢** 在 BizTalk Server 管理主控台，來搜尋特定類別的訊息 索引標籤。  
...
4.  在 **查詢運算式** 群組 **值** 欄中，選取 **訊息** 從下拉式清單方塊。  
...
5.  在 **欄位名稱** 欄中的空白下拉式清單方塊旁邊的星號 (**\***)，選取一或多個項目︰  
    ...
    |**錯誤配接器**|您可以將群組或篩選訊息，配接器類型︰ 檔案、 FTP、 HTTP、 MQSeries、 MSMQ、 POP3、 SMTP、 SOAP 或 Windows SharePoint Services。|  
    |**錯誤碼**|您可以使用錯誤碼來分組或篩選訊息。|  
    |**錯誤描述**|您可以使用錯誤描述來分組或篩選訊息。|  
    |**主機名稱**|您可以使用主控件名稱來分組或篩選訊息。|  
