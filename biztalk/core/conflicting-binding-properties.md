...
ms.locfileid: "22233238"
---
# <a name="conflicting-binding-properties"></a>衝突的繫結屬性
...
|元件|0|  
|符號名稱|0|  
|訊息文字|衝突的繫結屬性： MsmqAuthenticationMode = {0}，而 MsmqProtectionLevel = \ {1 \} 無效。 變更其中一個來解決衝突的屬性|  
  
## <a name="explanation"></a>說明  
 Wcf-netmsmq 傳輸的 MSMQ 保護層級屬性設定為**登**或**EncryptAndSign**無 MSMQ 驗證模式。  
  
## <a name="user-action"></a>使用者動作  
 變更 MSMQ 保護層級或 MSMQ 驗證模式屬性，與 MSMQ 保護層級內容一致。  
...
9. 請檢查 MSMQ 中的值**驗證模式**清單和**MSMQ 保護等級**清單。  
  
 如需詳細資訊，請參閱下列資源[!INCLUDE[btsBizTalkServerNoVersion](../includes/btsbiztalkservernoversion-md.md)]協助：  
