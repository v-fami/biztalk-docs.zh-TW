...
本主題描述如何使用 [BizTalk Server 管理主控台] 或命令列，從 .xml 檔案將繫結匯入到 BizTalk 群組。 如需從 BizTalk 群組匯出繫結，可以匯入的.xml 檔案的指示，請參閱[如何匯出 BizTalk 群組的繫結](../core/how-to-export-bindings-for-a-biztalk-group.md)。  
 ...
 您也可以匯入繫結至 BizTalk 應用程式中所述[如何匯入到 BizTalk 應用程式的繫結](../core/how-to-import-bindings-into-a-biztalk-application.md)。  
...
2.  在主控台樹狀目錄中，依序展開**BizTalk Server 管理**，再展開 [BizTalk 群組]，然後以滑鼠右鍵按一下**應用程式**。  
...
2.  輸入下列命令，並以適當的值替代，如下表所述：  
     ...
     **BTSTask ImportBindings /Source:** *值* **/GroupLevel** [**/Server:***值*] [**/資料庫：***值*]  
