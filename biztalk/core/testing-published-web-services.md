...
開發 Web 服務時，您可能會想要藉由重新發佈 Web 服務來予以測試。 每次重新發佈 Web 服務之後，您都必須重設 Internet Information Services (IIS)。  
 ...
 您可以藉由建立 Web 服務用戶端應用程式，或是使用如 Internet Explorer 的瀏覽器來測試已發佈 Web 服務。  
  
## <a name="in-this-section"></a>本節內容  
  
-   [建立.NET 應用程式來測試已發佈的 Web 服務](../core/creating-a-net-application-to-test-a-published-web-service.md)  
  
-   [如何使用 Internet Explorer 測試已發佈的 Web 服務](../core/how-to-use-internet-explorer-to-test-a-published-web-service.md)