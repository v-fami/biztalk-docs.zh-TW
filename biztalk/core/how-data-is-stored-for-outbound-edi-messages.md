...
## <a name="data-stored-by-the-send-pipeline-for-outbound-interchanges"></a><span data-ttu-id="e25b7-109">傳送管線所儲存的輸出交換資料</span><span class="sxs-lookup"><span data-stu-id="e25b7-109">Data Stored by the Send Pipeline for Outbound Interchanges</span></span>  
...
|<span data-ttu-id="e25b7-144">通知/動作代碼中的資料</span><span class="sxs-lookup"><span data-stu-id="e25b7-144">Data in ACK/Action Code</span></span>|<span data-ttu-id="e25b7-145">報告的錯誤描述</span><span class="sxs-lookup"><span data-stu-id="e25b7-145">Error description for Reporting</span></span>|<span data-ttu-id="e25b7-146">註解 (適用性)</span><span class="sxs-lookup"><span data-stu-id="e25b7-146">Comment (applicability)</span></span>|  
|------------------------------|-------------------------------------|-------------------------------|  
...
|<span data-ttu-id="e25b7-188">010</span><span class="sxs-lookup"><span data-stu-id="e25b7-188">010</span></span>|<span data-ttu-id="e25b7-189">無效的授權資訊辨識符號值</span><span class="sxs-lookup"><span data-stu-id="e25b7-189">Invalid Authorization Information Qualifier Value</span></span>|  
...
-   <span data-ttu-id="e25b7-258">交換通知時間 = 更新資料</span><span class="sxs-lookup"><span data-stu-id="e25b7-258">Interchange ACK Time = Update Data</span></span>  
...
|<span data-ttu-id="e25b7-300">007</span><span class="sxs-lookup"><span data-stu-id="e25b7-300">007</span></span>|<span data-ttu-id="e25b7-301">無效的接收者交換識別碼辨識符號</span><span class="sxs-lookup"><span data-stu-id="e25b7-301">Invalid Interchange ID Qualifier for Receiver</span></span>|  
...
|<span data-ttu-id="e25b7-344">029</span><span class="sxs-lookup"><span data-stu-id="e25b7-344">029</span></span>|<span data-ttu-id="e25b7-345">延遲傳遞要求中無效的傳遞時間</span><span class="sxs-lookup"><span data-stu-id="e25b7-345">Invalid Delivery Time in Deferred Delivery Request</span></span>|  
...
-   <span data-ttu-id="e25b7-366">功能通知交換控制識別碼= 未指定值 – 會由傳送端套用</span><span class="sxs-lookup"><span data-stu-id="e25b7-366">Functional ACK Interchange Control ID= Not value – will be applied by send side</span></span>  
...
|<span data-ttu-id="e25b7-396">7</span><span class="sxs-lookup"><span data-stu-id="e25b7-396">7</span></span>|<span data-ttu-id="e25b7-397">已接受/已部分接受</span><span class="sxs-lookup"><span data-stu-id="e25b7-397">Accepted/Partially Accepted</span></span>|<span data-ttu-id="e25b7-398">EDIFACT</span><span class="sxs-lookup"><span data-stu-id="e25b7-398">EDIFACT</span></span>|  
 ...
 <span data-ttu-id="e25b7-399">EDIFACT 將使用的錯誤/語法錯誤碼如下：</span><span class="sxs-lookup"><span data-stu-id="e25b7-399">The following Error/Syntax Error Codes will be used for EDIFACT:</span></span>  
...
|<span data-ttu-id="e25b7-443">30</span><span class="sxs-lookup"><span data-stu-id="e25b7-443">30</span></span>|<span data-ttu-id="e25b7-444">群組和訊息/封裝已混合</span><span class="sxs-lookup"><span data-stu-id="e25b7-444">Groups and messages/packages mixed</span></span>|  
...
|<span data-ttu-id="e25b7-487">74</span><span class="sxs-lookup"><span data-stu-id="e25b7-487">74</span></span>|<span data-ttu-id="e25b7-488">區段群組的重複太少</span><span class="sxs-lookup"><span data-stu-id="e25b7-488">Too few segment group repetitions</span></span>|  
...
-   <span data-ttu-id="e25b7-550">錯誤/語法錯誤碼  = (X12 AK905 和 UCI5) 參閱說明 2</span><span class="sxs-lookup"><span data-stu-id="e25b7-550">Error/Syntax Error Code  = (X12 AK905 and UCI5) Refer Note 2</span></span>  
...
|<span data-ttu-id="e25b7-565">R、M、W、X</span><span class="sxs-lookup"><span data-stu-id="e25b7-565">R, M, W, X</span></span>|<span data-ttu-id="e25b7-566">已拒絕</span><span class="sxs-lookup"><span data-stu-id="e25b7-566">Rejected</span></span>|<span data-ttu-id="e25b7-567">X12</span><span class="sxs-lookup"><span data-stu-id="e25b7-567">X12</span></span>|  
|<span data-ttu-id="e25b7-568">E</span><span class="sxs-lookup"><span data-stu-id="e25b7-568">E</span></span>|<span data-ttu-id="e25b7-569">已接受，發生錯誤</span><span class="sxs-lookup"><span data-stu-id="e25b7-569">Accepted with errors</span></span>|<span data-ttu-id="e25b7-570">X12</span><span class="sxs-lookup"><span data-stu-id="e25b7-570">X12</span></span>|  
|<span data-ttu-id="e25b7-571">4</span><span class="sxs-lookup"><span data-stu-id="e25b7-571">4</span></span>|<span data-ttu-id="e25b7-572">已拒絕</span><span class="sxs-lookup"><span data-stu-id="e25b7-572">Rejected</span></span>|<span data-ttu-id="e25b7-573">EDIFACT</span><span class="sxs-lookup"><span data-stu-id="e25b7-573">EDIFACT</span></span>|  
|<span data-ttu-id="e25b7-574">7, 8</span><span class="sxs-lookup"><span data-stu-id="e25b7-574">7, 8</span></span>|<span data-ttu-id="e25b7-575">已接受/已部分接受</span><span class="sxs-lookup"><span data-stu-id="e25b7-575">Accepted/Partially Accepted</span></span>|<span data-ttu-id="e25b7-576">EDIFACT</span><span class="sxs-lookup"><span data-stu-id="e25b7-576">EDIFACT</span></span>|  
  
 <span data-ttu-id="e25b7-577">EDIFACT 將使用的錯誤/語法錯誤碼如下：</span><span class="sxs-lookup"><span data-stu-id="e25b7-577">The following Error/Syntax Error Codes will be used for EDIFACT:</span></span>  
  
|<span data-ttu-id="e25b7-578">錯誤/語法錯誤碼中的資料</span><span class="sxs-lookup"><span data-stu-id="e25b7-578">Data in Error/Syntax Error Cod</span></span><br /><br /> <span data-ttu-id="e25b7-579">(適用於 EDIFACT)</span><span class="sxs-lookup"><span data-stu-id="e25b7-579">(applicable to EDIFACT)</span></span>|<span data-ttu-id="e25b7-580">報告的錯誤描述</span><span class="sxs-lookup"><span data-stu-id="e25b7-580">Error Description for reporting</span></span>|  
|-------------------------------------------------------------------|-------------------------------------|  
|<span data-ttu-id="e25b7-581">2</span><span class="sxs-lookup"><span data-stu-id="e25b7-581">2</span></span>|<span data-ttu-id="e25b7-582">語法版本或層級不支援</span><span class="sxs-lookup"><span data-stu-id="e25b7-582">Syntax version or level not supported</span></span>|  
|<span data-ttu-id="e25b7-583">7</span><span class="sxs-lookup"><span data-stu-id="e25b7-583">7</span></span>|<span data-ttu-id="e25b7-584">交換收件者不是實際收件者</span><span class="sxs-lookup"><span data-stu-id="e25b7-584">Interchange recipient not actual recipient</span></span>|  
|<span data-ttu-id="e25b7-585">12</span><span class="sxs-lookup"><span data-stu-id="e25b7-585">12</span></span>|<span data-ttu-id="e25b7-586">無效值</span><span class="sxs-lookup"><span data-stu-id="e25b7-586">Invalid value</span></span>|  
|<span data-ttu-id="e25b7-587">13</span><span class="sxs-lookup"><span data-stu-id="e25b7-587">13</span></span>|<span data-ttu-id="e25b7-588">Missing</span><span class="sxs-lookup"><span data-stu-id="e25b7-588">Missing</span></span>|  
|<span data-ttu-id="e25b7-589">14</span><span class="sxs-lookup"><span data-stu-id="e25b7-589">14</span></span>|<span data-ttu-id="e25b7-590">在這個位置中不支援的值</span><span class="sxs-lookup"><span data-stu-id="e25b7-590">Value not supported in this position</span></span>|  
|<span data-ttu-id="e25b7-591">15</span><span class="sxs-lookup"><span data-stu-id="e25b7-591">15</span></span>|<span data-ttu-id="e25b7-592">在這個位置中不支援</span><span class="sxs-lookup"><span data-stu-id="e25b7-592">Not supported in this position</span></span>|  
|<span data-ttu-id="e25b7-593">16</span><span class="sxs-lookup"><span data-stu-id="e25b7-593">16</span></span>|<span data-ttu-id="e25b7-594">太多結構成分</span><span class="sxs-lookup"><span data-stu-id="e25b7-594">Too many constituents</span></span>|  
|<span data-ttu-id="e25b7-595">17</span><span class="sxs-lookup"><span data-stu-id="e25b7-595">17</span></span>|<span data-ttu-id="e25b7-596">沒有協議</span><span class="sxs-lookup"><span data-stu-id="e25b7-596">No agreement</span></span>|  
|<span data-ttu-id="e25b7-597">18</span><span class="sxs-lookup"><span data-stu-id="e25b7-597">18</span></span>|<span data-ttu-id="e25b7-598">未指定的錯誤</span><span class="sxs-lookup"><span data-stu-id="e25b7-598">Unspecified error</span></span>|  
|<span data-ttu-id="e25b7-599">19</span><span class="sxs-lookup"><span data-stu-id="e25b7-599">19</span></span>|<span data-ttu-id="e25b7-600">無效的小數點標記</span><span class="sxs-lookup"><span data-stu-id="e25b7-600">Invalid decimal notation</span></span>|  
|<span data-ttu-id="e25b7-601">20</span><span class="sxs-lookup"><span data-stu-id="e25b7-601">20</span></span>|<span data-ttu-id="e25b7-602">字元做為服務字元無效</span><span class="sxs-lookup"><span data-stu-id="e25b7-602">Character invalid as service character</span></span>|  
|<span data-ttu-id="e25b7-603">21</span><span class="sxs-lookup"><span data-stu-id="e25b7-603">21</span></span>|<span data-ttu-id="e25b7-604">無效字元</span><span class="sxs-lookup"><span data-stu-id="e25b7-604">Invalid character(s)</span></span>|  
|<span data-ttu-id="e25b7-605">22</span><span class="sxs-lookup"><span data-stu-id="e25b7-605">22</span></span>|<span data-ttu-id="e25b7-606">服務字元無效</span><span class="sxs-lookup"><span data-stu-id="e25b7-606">Invalid service character(s)</span></span>|  
|<span data-ttu-id="e25b7-607">23</span><span class="sxs-lookup"><span data-stu-id="e25b7-607">23</span></span>|<span data-ttu-id="e25b7-608">未知的交換傳送者</span><span class="sxs-lookup"><span data-stu-id="e25b7-608">Unknown Interchange sender</span></span>|  
|<span data-ttu-id="e25b7-609">24</span><span class="sxs-lookup"><span data-stu-id="e25b7-609">24</span></span>|<span data-ttu-id="e25b7-610">太舊</span><span class="sxs-lookup"><span data-stu-id="e25b7-610">Too old</span></span>|  
|<span data-ttu-id="e25b7-611">25</span><span class="sxs-lookup"><span data-stu-id="e25b7-611">25</span></span>|<span data-ttu-id="e25b7-612">不支援測試指示符號</span><span class="sxs-lookup"><span data-stu-id="e25b7-612">Test indicator not supported</span></span>|  
|<span data-ttu-id="e25b7-613">26</span><span class="sxs-lookup"><span data-stu-id="e25b7-613">26</span></span>|<span data-ttu-id="e25b7-614">偵測到重複</span><span class="sxs-lookup"><span data-stu-id="e25b7-614">Duplicate detected</span></span>|  
|<span data-ttu-id="e25b7-615">27</span><span class="sxs-lookup"><span data-stu-id="e25b7-615">27</span></span>|<span data-ttu-id="e25b7-616">不支援安全性函式</span><span class="sxs-lookup"><span data-stu-id="e25b7-616">Security function not supported</span></span>|  
|<span data-ttu-id="e25b7-617">28</span><span class="sxs-lookup"><span data-stu-id="e25b7-617">28</span></span>|<span data-ttu-id="e25b7-618">參考不相符</span><span class="sxs-lookup"><span data-stu-id="e25b7-618">References do not match</span></span>|  
|<span data-ttu-id="e25b7-619">29</span><span class="sxs-lookup"><span data-stu-id="e25b7-619">29</span></span>|<span data-ttu-id="e25b7-620">控制計數不符合接收到的執行個體數目</span><span class="sxs-lookup"><span data-stu-id="e25b7-620">Control count does not match number of instances received</span></span>|  
|<span data-ttu-id="e25b7-621">30</span><span class="sxs-lookup"><span data-stu-id="e25b7-621">30</span></span>|<span data-ttu-id="e25b7-622">群組和訊息/封裝已混合</span><span class="sxs-lookup"><span data-stu-id="e25b7-622">Groups and messages/packages mixed</span></span>|  
|<span data-ttu-id="e25b7-623">31</span><span class="sxs-lookup"><span data-stu-id="e25b7-623">31</span></span>|<span data-ttu-id="e25b7-624">群組中有一種以上的訊息類型</span><span class="sxs-lookup"><span data-stu-id="e25b7-624">More than one message type in group</span></span>|  
|<span data-ttu-id="e25b7-625">32</span><span class="sxs-lookup"><span data-stu-id="e25b7-625">32</span></span>|<span data-ttu-id="e25b7-626">較低層級空白</span><span class="sxs-lookup"><span data-stu-id="e25b7-626">Lower level empty</span></span>|  
|<span data-ttu-id="e25b7-627">33</span><span class="sxs-lookup"><span data-stu-id="e25b7-627">33</span></span>|<span data-ttu-id="e25b7-628">在訊息、封裝或群組外部出現的項目無效</span><span class="sxs-lookup"><span data-stu-id="e25b7-628">Invalid occurrence outside message, package, or group</span></span>|  
|<span data-ttu-id="e25b7-629">34</span><span class="sxs-lookup"><span data-stu-id="e25b7-629">34</span></span>|<span data-ttu-id="e25b7-630">不允許巢狀指示符號</span><span class="sxs-lookup"><span data-stu-id="e25b7-630">Nesting indicator not allowed</span></span>|  
|<span data-ttu-id="e25b7-631">35</span><span class="sxs-lookup"><span data-stu-id="e25b7-631">35</span></span>|<span data-ttu-id="e25b7-632">太多資料元素或區段重複</span><span class="sxs-lookup"><span data-stu-id="e25b7-632">Too many data element or segment repetitions</span></span>|  
|<span data-ttu-id="e25b7-633">36</span><span class="sxs-lookup"><span data-stu-id="e25b7-633">36</span></span>|<span data-ttu-id="e25b7-634">太多區段群組重複</span><span class="sxs-lookup"><span data-stu-id="e25b7-634">Too many segment group repetitions</span></span>|  
|<span data-ttu-id="e25b7-635">37</span><span class="sxs-lookup"><span data-stu-id="e25b7-635">37</span></span>|<span data-ttu-id="e25b7-636">無效字元類型</span><span class="sxs-lookup"><span data-stu-id="e25b7-636">Invalid type of character(s)</span></span>|  
|<span data-ttu-id="e25b7-637">38</span><span class="sxs-lookup"><span data-stu-id="e25b7-637">38</span></span>|<span data-ttu-id="e25b7-638">在小數符號之前遺失數字</span><span class="sxs-lookup"><span data-stu-id="e25b7-638">Missing digit in front of decimal sign</span></span>|  
|<span data-ttu-id="e25b7-639">39</span><span class="sxs-lookup"><span data-stu-id="e25b7-639">39</span></span>|<span data-ttu-id="e25b7-640">資料元素太長</span><span class="sxs-lookup"><span data-stu-id="e25b7-640">Data element too long</span></span>|  
|<span data-ttu-id="e25b7-641">40</span><span class="sxs-lookup"><span data-stu-id="e25b7-641">40</span></span>|<span data-ttu-id="e25b7-642">資料元素太短</span><span class="sxs-lookup"><span data-stu-id="e25b7-642">Data element too short</span></span>|  
|<span data-ttu-id="e25b7-643">41</span><span class="sxs-lookup"><span data-stu-id="e25b7-643">41</span></span>|<span data-ttu-id="e25b7-644">永久通訊網路錯誤</span><span class="sxs-lookup"><span data-stu-id="e25b7-644">Permanent communication network error</span></span>|  
|<span data-ttu-id="e25b7-645">42</span><span class="sxs-lookup"><span data-stu-id="e25b7-645">42</span></span>|<span data-ttu-id="e25b7-646">暫時通訊網路錯誤</span><span class="sxs-lookup"><span data-stu-id="e25b7-646">Temporary communication network error</span></span>|  
|<span data-ttu-id="e25b7-647">43</span><span class="sxs-lookup"><span data-stu-id="e25b7-647">43</span></span>|<span data-ttu-id="e25b7-648">未知的交換收件者</span><span class="sxs-lookup"><span data-stu-id="e25b7-648">Unknown interchange recipient</span></span>|  
|<span data-ttu-id="e25b7-649">45</span><span class="sxs-lookup"><span data-stu-id="e25b7-649">45</span></span>|<span data-ttu-id="e25b7-650">尾端分隔符號</span><span class="sxs-lookup"><span data-stu-id="e25b7-650">Trailing separator</span></span>|  
|<span data-ttu-id="e25b7-651">46</span><span class="sxs-lookup"><span data-stu-id="e25b7-651">46</span></span>|<span data-ttu-id="e25b7-652">不支援字元集</span><span class="sxs-lookup"><span data-stu-id="e25b7-652">Character set not supported</span></span>|  
|<span data-ttu-id="e25b7-653">47</span><span class="sxs-lookup"><span data-stu-id="e25b7-653">47</span></span>|<span data-ttu-id="e25b7-654">不支援信封功能</span><span class="sxs-lookup"><span data-stu-id="e25b7-654">Envelope functionality not supported</span></span>|  
|<span data-ttu-id="e25b7-655">48</span><span class="sxs-lookup"><span data-stu-id="e25b7-655">48</span></span>|<span data-ttu-id="e25b7-656">違反相依性條件</span><span class="sxs-lookup"><span data-stu-id="e25b7-656">Dependency condition violated</span></span>|  
|<span data-ttu-id="e25b7-657">70</span><span class="sxs-lookup"><span data-stu-id="e25b7-657">70</span></span>|<span data-ttu-id="e25b7-658">交易集遺失或是交易集識別碼無效</span><span class="sxs-lookup"><span data-stu-id="e25b7-658">Transaction set is missing or invalid transaction set Identifier</span></span>|  
|<span data-ttu-id="e25b7-659">71</span><span class="sxs-lookup"><span data-stu-id="e25b7-659">71</span></span>|<span data-ttu-id="e25b7-660">交易集或群組控制編號不相符</span><span class="sxs-lookup"><span data-stu-id="e25b7-660">Transaction set or group control number mismatch</span></span>|  
|<span data-ttu-id="e25b7-661">72</span><span class="sxs-lookup"><span data-stu-id="e25b7-661">72</span></span>|<span data-ttu-id="e25b7-662">無法辨識的區段識別碼</span><span class="sxs-lookup"><span data-stu-id="e25b7-662">Unrecognized segment ID</span></span>|  
|<span data-ttu-id="e25b7-663">73</span><span class="sxs-lookup"><span data-stu-id="e25b7-663">73</span></span>|<span data-ttu-id="e25b7-664">XML 不在正確的位置</span><span class="sxs-lookup"><span data-stu-id="e25b7-664">XML not at correct position</span></span>|  
|<span data-ttu-id="e25b7-665">74</span><span class="sxs-lookup"><span data-stu-id="e25b7-665">74</span></span>|<span data-ttu-id="e25b7-666">區段群組的重複太少</span><span class="sxs-lookup"><span data-stu-id="e25b7-666">Too few segment group repetitions</span></span>|  
|<span data-ttu-id="e25b7-667">75</span><span class="sxs-lookup"><span data-stu-id="e25b7-667">75</span></span>|<span data-ttu-id="e25b7-668">區段的重複太少</span><span class="sxs-lookup"><span data-stu-id="e25b7-668">Too few segment repetitions</span></span>|  
|<span data-ttu-id="e25b7-669">76</span><span class="sxs-lookup"><span data-stu-id="e25b7-669">76</span></span>|<span data-ttu-id="e25b7-670">找到的資料元素太少</span><span class="sxs-lookup"><span data-stu-id="e25b7-670">Too few data elements found</span></span>|  
  
 <span data-ttu-id="e25b7-671">X12 將使用的錯誤/語法錯誤碼如下：</span><span class="sxs-lookup"><span data-stu-id="e25b7-671">The following Error/Syntax Error Codes will be used for X12:</span></span>  
  
|<span data-ttu-id="e25b7-672">錯誤/語法錯誤碼中的資料</span><span class="sxs-lookup"><span data-stu-id="e25b7-672">Data in Error/Syntax Error Code</span></span><br /><br /> <span data-ttu-id="e25b7-673">(適用於 X12)</span><span class="sxs-lookup"><span data-stu-id="e25b7-673">(applicable to X12)</span></span>|<span data-ttu-id="e25b7-674">報告的錯誤描述</span><span class="sxs-lookup"><span data-stu-id="e25b7-674">Error Description for reporting</span></span>|  
|----------------------------------------------------------------|-------------------------------------|  
|<span data-ttu-id="e25b7-675">1</span><span class="sxs-lookup"><span data-stu-id="e25b7-675">1</span></span>|<span data-ttu-id="e25b7-676">不支援功能群組</span><span class="sxs-lookup"><span data-stu-id="e25b7-676">Functional group not supported</span></span>|  
|<span data-ttu-id="e25b7-677">2</span><span class="sxs-lookup"><span data-stu-id="e25b7-677">2</span></span>|<span data-ttu-id="e25b7-678">不支援功能群組版本</span><span class="sxs-lookup"><span data-stu-id="e25b7-678">Functional group version not supported</span></span>|  
|<span data-ttu-id="e25b7-679">3</span><span class="sxs-lookup"><span data-stu-id="e25b7-679">3</span></span>|<span data-ttu-id="e25b7-680">遺失功能群組結尾</span><span class="sxs-lookup"><span data-stu-id="e25b7-680">Functional group trailer missing</span></span>|  
|<span data-ttu-id="e25b7-681">4</span><span class="sxs-lookup"><span data-stu-id="e25b7-681">4</span></span>|<span data-ttu-id="e25b7-682">功能群組標頭與結尾中的群組控制編號不相符</span><span class="sxs-lookup"><span data-stu-id="e25b7-682">Group control number in the functional group header and trailer do not agree</span></span>|  
|<span data-ttu-id="e25b7-683">5</span><span class="sxs-lookup"><span data-stu-id="e25b7-683">5</span></span>|<span data-ttu-id="e25b7-684">包含的交易集數目不符合實際計數</span><span class="sxs-lookup"><span data-stu-id="e25b7-684">Number of included transaction sets does not match actual count</span></span>|  
|<span data-ttu-id="e25b7-685">6-26</span><span class="sxs-lookup"><span data-stu-id="e25b7-685">6-26</span></span>|<span data-ttu-id="e25b7-686">其他不支援的驗證錯誤</span><span class="sxs-lookup"><span data-stu-id="e25b7-686">Other unsupported validation errors</span></span>|  
  
## <a name="see-also"></a><span data-ttu-id="e25b7-687">另請參閱</span><span class="sxs-lookup"><span data-stu-id="e25b7-687">See Also</span></span>  
 <span data-ttu-id="e25b7-688">[資料如何儲存 EDI 和 AS2 狀態報告](../core/how-data-is-stored-for-edi-and-as2-status-reports.md) </span><span class="sxs-lookup"><span data-stu-id="e25b7-688">[How Data Is Stored for EDI and AS2 Status Reports](../core/how-data-is-stored-for-edi-and-as2-status-reports.md) </span></span>  
 [<span data-ttu-id="e25b7-689">資料如何儲存輸入的 EDI 訊息</span><span class="sxs-lookup"><span data-stu-id="e25b7-689">How Data Is Stored for Inbound EDI Messages</span></span>](../core/how-data-is-stored-for-inbound-edi-messages.md)