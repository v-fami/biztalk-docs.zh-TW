...
3. 在上**群組內容**] 對話方塊中，按一下**憑證**，按一下 [**瀏覽**。  
  
4. 在 [**選取憑證**] 對話方塊中，選取的簽署的憑證，您已安裝，，，然後關閉所有對話方塊。  
  
## <a name="next-steps"></a>後續步驟  
 建立管線來接收簽署的訊息[如何設定接收簽署的訊息的 BizTalk Server](../core/how-to-configure-biztalk-server-for-receiving-signed-messages.md)。  
  
 建立管線來傳送簽署的訊息[如何設定傳送簽署訊息的 BizTalk Server](../core/how-to-configure-biztalk-server-for-sending-signed-messages.md)。  
