...
layout: HubPage
hide_bc: true
title: Host Integration Server 文件
description: HIS 文件
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>什麼是 HIS</h3>
                                                    <p>HIS 可擴充 IBM 主機系統使用功能，並讓您以較少的自訂編碼來建立應用程式</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>新功能</h3>
                                                    <p>了解最新的 HIS 版本新功能，包括支援的系統和產品增強功能</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>深入了解安裝和設定、工具、資料類型對應、安全性等資訊</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
